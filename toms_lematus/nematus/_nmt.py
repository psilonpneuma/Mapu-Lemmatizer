...
def train(dim_word=512,  # word vector dimensionality
          ...
          saveto='model.npz',
          validFreq=10000,
          validBurnIn=10000, #Burn in value - don't do validation for this many updates
    ...
    for training_progress.eidx in xrange(training_progress.eidx, max_epochs):
        ...
        for x, y in train:
            ...
            if training_progress.uidx > validBurnIn:
                logging.info("Burn-in phase ended.")
            if valid is not None and validFreq and numpy.mod(training_progress.uidx, validFreq) == 0 and training_progress.uidx > validBurnIn:
                logging.info("training progess {}.".format(training_progress.uidx))
