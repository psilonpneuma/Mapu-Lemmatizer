...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_356ed890ede584f74cded607c9c91cf8 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_356ed890ede584f74cded607c9c91cf8() {
        ...
        ~__struct_compiled_op_356ed890ede584f74cded607c9c91cf8(void) {
            cleanup();
        }
...
// Op class Elemwise
        ...
        goto __label_17;}
                ...
                V15_jumpx_1 = -(0);
                //printf("V15_jumpx_1 is:");
                //std::cout << V15_jumpx_1 << std::endl;
...
dims[1] = V3_n1;
        ...
        if (!V1) {
            V1 = (PyArrayObject*)PyArray_EMPTY(2, dims,
                                                    NPY_FLOAT32,
                                                    PyArray_ISFORTRAN(V3) && PyArray_ISFORTRAN(V5) && PyArray_ISFORTRAN(V11));
        }
        else {
...
V1_stride0, V1_stride1
    ...
    std::vector< std::pair<int, int> >::reverse_iterator V1_loops_rit;
        ...
        V1_loops_rit = V1_loops.rbegin();
            int V1_stride_l1 = init_strides[7][V1_loops_rit->second];
            ++V1_loops_rit;
            
            int V1_stride_l0 = init_strides[7][V1_loops_rit->second];
            ++V1_loops_rit;
...
npy_float32 &V1_i = * ( V1_iter+V1_stride_l1*ITER_1+V1_stride_l0*ITER_0);
            ...
            
        {
            ...
            {
npy_bool V17_tmp1;
V17_tmp1 = (V11_i < V13_i);
npy_float32 V17_tmp2;
V17_tmp2 = V3_i / V5_i;
npy_float32 V17_tmp3;
V17_tmp3 = (npy_float32)V17_tmp1;
npy_float32 V17_tmp4;
V17_tmp4 = V9_i * V17_tmp3;
npy_float32 V17_tmp5;
V17_tmp5 = V7_i ? V17_tmp4 : V15_i;
V1_i = V17_tmp2 * V17_tmp5;
}
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_356ed890ede584f74cded607c9c91cf8_executor(__struct_compiled_op_356ed890ede584f74cded607c9c91cf8* self) {
            return self->run();
        }

        static void __struct_compiled_op_356ed890ede584f74cded607c9c91cf8_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_356ed890ede584f74cded607c9c91cf8*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_356ed890ede584f74cded607c9c91cf8* struct_ptr = new __struct_compiled_op_356ed890ede584f74cded607c9c91cf8();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_356ed890ede584f74cded607c9c91cf8_executor), struct_ptr, __struct_compiled_op_356ed890ede584f74cded607c9c91cf8_destructor);
  return thunk; }
...
PyMODINIT_FUNC init356ed890ede584f74cded607c9c91cf8(void){
   import_array();
   (void) Py_InitModule("356ed890ede584f74cded607c9c91cf8", MyMethods);
}
