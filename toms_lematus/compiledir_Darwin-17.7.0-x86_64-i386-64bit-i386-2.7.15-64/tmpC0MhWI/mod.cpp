...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_4f062c1b8da0fc563fb3ae5a51e2caf7 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_4f062c1b8da0fc563fb3ae5a51e2caf7() {
        ...
        ~__struct_compiled_op_4f062c1b8da0fc563fb3ae5a51e2caf7(void) {
            cleanup();
        }
...
npy_int64& V1_i = *V1_iter;
                  ...
                  {
npy_int64 V15_tmp1;
V15_tmp1 = V5_i + V7_i + V7_i;
npy_int64 V15_tmp2;
{
npy_int64 V15_1_tmp1;
V15_1_tmp1 = V9_i ? V5_i : V15_tmp1;
V15_tmp2 = V15_tmp1 - V15_1_tmp1;
}

npy_bool V15_tmp3;
V15_tmp3 = (V15_tmp2 < V11_i);
npy_int64 V15_tmp4;
V15_tmp4 = V15_tmp3 ? V11_i : V15_tmp2;
V1_i = V3_i ? V15_tmp4 : V13_i;
}
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_4f062c1b8da0fc563fb3ae5a51e2caf7_executor(__struct_compiled_op_4f062c1b8da0fc563fb3ae5a51e2caf7* self) {
            return self->run();
        }

        static void __struct_compiled_op_4f062c1b8da0fc563fb3ae5a51e2caf7_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_4f062c1b8da0fc563fb3ae5a51e2caf7*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_4f062c1b8da0fc563fb3ae5a51e2caf7* struct_ptr = new __struct_compiled_op_4f062c1b8da0fc563fb3ae5a51e2caf7();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_4f062c1b8da0fc563fb3ae5a51e2caf7_executor), struct_ptr, __struct_compiled_op_4f062c1b8da0fc563fb3ae5a51e2caf7_destructor);
  return thunk; }
...
PyMODINIT_FUNC init4f062c1b8da0fc563fb3ae5a51e2caf7(void){
   import_array();
   (void) Py_InitModule("4f062c1b8da0fc563fb3ae5a51e2caf7", MyMethods);
}
