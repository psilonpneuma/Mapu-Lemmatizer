...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_612fb0f657cd432b06246bd0806a2af2 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_612fb0f657cd432b06246bd0806a2af2() {
        ...
        ~__struct_compiled_op_612fb0f657cd432b06246bd0806a2af2(void) {
            cleanup();
        }
...
dims[1] = V9_n1;
        ...
        if (!V1) {
            V1 = (PyArrayObject*)PyArray_EMPTY(2, dims,
                                                    NPY_FLOAT32,
                                                    PyArray_ISFORTRAN(V3) && PyArray_ISFORTRAN(V9));
        }
        else {
...
V1_stride0, V1_stride1
    ...
    std::vector< std::pair<int, int> >::reverse_iterator V1_loops_rit;
        ...
        V1_loops_rit = V1_loops.rbegin();
            int V1_stride_l1 = init_strides[4][V1_loops_rit->second];
            ++V1_loops_rit;
            
            int V1_stride_l0 = init_strides[4][V1_loops_rit->second];
            ++V1_loops_rit;
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_612fb0f657cd432b06246bd0806a2af2_executor(__struct_compiled_op_612fb0f657cd432b06246bd0806a2af2* self) {
            return self->run();
        }

        static void __struct_compiled_op_612fb0f657cd432b06246bd0806a2af2_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_612fb0f657cd432b06246bd0806a2af2*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_612fb0f657cd432b06246bd0806a2af2* struct_ptr = new __struct_compiled_op_612fb0f657cd432b06246bd0806a2af2();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_612fb0f657cd432b06246bd0806a2af2_executor), struct_ptr, __struct_compiled_op_612fb0f657cd432b06246bd0806a2af2_destructor);
  return thunk; }
...
PyMODINIT_FUNC init612fb0f657cd432b06246bd0806a2af2(void){
   import_array();
   (void) Py_InitModule("612fb0f657cd432b06246bd0806a2af2", MyMethods);
}
