...
static float sdot_(int* Nx, float* x, int* Sx, float* y, int* Sy)
{
    ...
    namespace {
    struct __struct_compiled_op_053d97a61fd8b40d33e0d6fc83b30db7 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_053d97a61fd8b40d33e0d6fc83b30db7() {
        ...
        ~__struct_compiled_op_053d97a61fd8b40d33e0d6fc83b30db7(void) {
            cleanup();
        }
...
// Op class Gemm
        ...
        if ((NULL == V1)
            ...
            || (PyArray_STRIDES(V1)[0] <= 0)
            || (PyArray_STRIDES(V1)[1] <= 0)
            || (PyArray_STRIDES(V1)[0] MOD type_size)
            || (PyArray_STRIDES(V1)[1] MOD type_size)
            || ((PyArray_STRIDES(V1)[0] != type_size)
                && (PyArray_STRIDES(V1)[1] != type_size)))
        {
            Py_XDECREF(V1);
            npy_intp dims[2];
        ...
        if (PyArray_DESCR(V1)->type_num == NPY_FLOAT)
        {
            ...
            int zi = PyArray_STRIDES(V3)[0]/sizeof(float);
            int zj = PyArray_STRIDES(V3)[1]/sizeof(float);
        ...
        else if (PyArray_DESCR(V1)->type_num == NPY_DOUBLE)
        {
            ...
            int zi = PyArray_STRIDES(V3)[0]/sizeof(double);
            int zj = PyArray_STRIDES(V3)[1]/sizeof(double);
            for (int i = 0; i < Nz[0]; ++i)
            {
                for (int j = 0; j < Nz[1]; ++j)
                {
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_053d97a61fd8b40d33e0d6fc83b30db7_executor(__struct_compiled_op_053d97a61fd8b40d33e0d6fc83b30db7* self) {
            return self->run();
        }

        static void __struct_compiled_op_053d97a61fd8b40d33e0d6fc83b30db7_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_053d97a61fd8b40d33e0d6fc83b30db7*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_053d97a61fd8b40d33e0d6fc83b30db7* struct_ptr = new __struct_compiled_op_053d97a61fd8b40d33e0d6fc83b30db7();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_053d97a61fd8b40d33e0d6fc83b30db7_executor), struct_ptr, __struct_compiled_op_053d97a61fd8b40d33e0d6fc83b30db7_destructor);
  return thunk; }
...
PyMODINIT_FUNC init053d97a61fd8b40d33e0d6fc83b30db7(void){
   import_array();
   (void) Py_InitModule("053d97a61fd8b40d33e0d6fc83b30db7", MyMethods);
}
