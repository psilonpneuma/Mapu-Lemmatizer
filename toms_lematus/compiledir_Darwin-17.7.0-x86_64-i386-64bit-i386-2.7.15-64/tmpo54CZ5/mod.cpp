...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_5519302f94d3217742c7e77517d1d016 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_5519302f94d3217742c7e77517d1d016() {
        ...
        ~__struct_compiled_op_5519302f94d3217742c7e77517d1d016(void) {
            cleanup();
        }
...
// Op class Elemwise
        ...
        goto __label_11;}
            ...
            if((PyArray_ISCONTIGUOUS(V3) && PyArray_ISCONTIGUOUS(V5) && PyArray_ISCONTIGUOUS(V9) && PyArray_ISCONTIGUOUS(V1)) || (PyArray_ISFORTRAN(V3) && PyArray_ISFORTRAN(V5) && PyArray_ISFORTRAN(V9) && PyArray_ISFORTRAN(V1))){
...
V11_tmp2 = V7_i - V3_i;
npy_float32 V11_tmp3;
V11_tmp3 = V3_i * V5_i;
npy_float32 V11_tmp4;
V11_tmp4 = V11_tmp2 * V11_tmp1;
V1_i = V11_tmp3 + V11_tmp4;
}
;
                    }
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_5519302f94d3217742c7e77517d1d016_executor(__struct_compiled_op_5519302f94d3217742c7e77517d1d016* self) {
            return self->run();
        }

        static void __struct_compiled_op_5519302f94d3217742c7e77517d1d016_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_5519302f94d3217742c7e77517d1d016*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_5519302f94d3217742c7e77517d1d016* struct_ptr = new __struct_compiled_op_5519302f94d3217742c7e77517d1d016();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_5519302f94d3217742c7e77517d1d016_executor), struct_ptr, __struct_compiled_op_5519302f94d3217742c7e77517d1d016_destructor);
  return thunk; }
...
PyMODINIT_FUNC init5519302f94d3217742c7e77517d1d016(void){
   import_array();
   (void) Py_InitModule("5519302f94d3217742c7e77517d1d016", MyMethods);
}
