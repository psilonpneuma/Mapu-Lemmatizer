...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_c58f0c074be92f2556a35b2604aa7501 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_c58f0c074be92f2556a35b2604aa7501() {
        ...
        ~__struct_compiled_op_c58f0c074be92f2556a35b2604aa7501(void) {
            cleanup();
        }
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_c58f0c074be92f2556a35b2604aa7501_executor(__struct_compiled_op_c58f0c074be92f2556a35b2604aa7501* self) {
            return self->run();
        }

        static void __struct_compiled_op_c58f0c074be92f2556a35b2604aa7501_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_c58f0c074be92f2556a35b2604aa7501*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_c58f0c074be92f2556a35b2604aa7501* struct_ptr = new __struct_compiled_op_c58f0c074be92f2556a35b2604aa7501();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_c58f0c074be92f2556a35b2604aa7501_executor), struct_ptr, __struct_compiled_op_c58f0c074be92f2556a35b2604aa7501_destructor);
  return thunk; }
...
PyMODINIT_FUNC initc58f0c074be92f2556a35b2604aa7501(void){
   import_array();
   (void) Py_InitModule("c58f0c074be92f2556a35b2604aa7501", MyMethods);
}
