...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_b638859056373335e199d68de7bbc5e0 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_b638859056373335e199d68de7bbc5e0() {
        ...
        ~__struct_compiled_op_b638859056373335e199d68de7bbc5e0(void) {
            cleanup();
        }
...
V17_tmp2 = (V3_i <= V5_i);
npy_int64 V17_tmp3;
V17_tmp3 = V7_i + V17_tmp1;
npy_int64 V17_tmp4;
V17_tmp4 = ((V13_i)<(V17_tmp3)? (V13_i): ((V17_tmp3)<=(V13_i)? (V17_tmp3): nan("")));
npy_int64 V17_tmp5;
V17_tmp5 = ((V15_i)>(V17_tmp4)? (V15_i): ((V17_tmp4)>=(V15_i)? (V17_tmp4): nan("")));
V1_i = V17_tmp2 ? V5_i : V17_tmp5;
}
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_b638859056373335e199d68de7bbc5e0_executor(__struct_compiled_op_b638859056373335e199d68de7bbc5e0* self) {
            return self->run();
        }

        static void __struct_compiled_op_b638859056373335e199d68de7bbc5e0_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_b638859056373335e199d68de7bbc5e0*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_b638859056373335e199d68de7bbc5e0* struct_ptr = new __struct_compiled_op_b638859056373335e199d68de7bbc5e0();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_b638859056373335e199d68de7bbc5e0_executor), struct_ptr, __struct_compiled_op_b638859056373335e199d68de7bbc5e0_destructor);
  return thunk; }
...
PyMODINIT_FUNC initb638859056373335e199d68de7bbc5e0(void){
   import_array();
   (void) Py_InitModule("b638859056373335e199d68de7bbc5e0", MyMethods);
}
