...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_bb9d3b170056db80aeeae276839a37b4 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_bb9d3b170056db80aeeae276839a37b4() {
        ...
        ~__struct_compiled_op_bb9d3b170056db80aeeae276839a37b4(void) {
            cleanup();
        }
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_bb9d3b170056db80aeeae276839a37b4_executor(__struct_compiled_op_bb9d3b170056db80aeeae276839a37b4* self) {
            return self->run();
        }

        static void __struct_compiled_op_bb9d3b170056db80aeeae276839a37b4_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_bb9d3b170056db80aeeae276839a37b4*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_bb9d3b170056db80aeeae276839a37b4* struct_ptr = new __struct_compiled_op_bb9d3b170056db80aeeae276839a37b4();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_bb9d3b170056db80aeeae276839a37b4_executor), struct_ptr, __struct_compiled_op_bb9d3b170056db80aeeae276839a37b4_destructor);
  return thunk; }
...
PyMODINIT_FUNC initbb9d3b170056db80aeeae276839a37b4(void){
   import_array();
   (void) Py_InitModule("bb9d3b170056db80aeeae276839a37b4", MyMethods);
}
