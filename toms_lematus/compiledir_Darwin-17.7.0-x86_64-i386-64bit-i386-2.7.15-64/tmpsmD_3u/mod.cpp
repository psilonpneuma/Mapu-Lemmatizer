...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_aa71ab0d3045d39f0b6fb04ece3272c0 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_aa71ab0d3045d39f0b6fb04ece3272c0() {
        ...
        ~__struct_compiled_op_aa71ab0d3045d39f0b6fb04ece3272c0(void) {
            cleanup();
        }
...
dims[1] = V5_n1;
        ...
        if (!V1) {
            V1 = (PyArrayObject*)PyArray_EMPTY(2, dims,
                                                    NPY_FLOAT32,
                                                    PyArray_ISFORTRAN(V3) && PyArray_ISFORTRAN(V5) && PyArray_ISFORTRAN(V7) && PyArray_ISFORTRAN(V11) && PyArray_ISFORTRAN(V13));
        }
        else {
...
V1_stride0, V1_stride1
    ...
    std::vector< std::pair<int, int> >::reverse_iterator V1_loops_rit;
        ...
        V1_loops_rit = V1_loops.rbegin();
            int V1_stride_l1 = init_strides[6][V1_loops_rit->second];
            ++V1_loops_rit;
            
            int V1_stride_l0 = init_strides[6][V1_loops_rit->second];
            ++V1_loops_rit;
...
V15_tmp3 = V5_i * V7_i;
npy_float32 V15_tmp4;
V15_tmp4 = V9_i - V5_i;
npy_float32 V15_tmp5;
V15_tmp5 = V15_tmp4 * V15_tmp2;
npy_float32 V15_tmp6;
V15_tmp6 = V15_tmp3 + V15_tmp5;
npy_float32 V15_tmp7;
V15_tmp7 = V3_i * V15_tmp6;
V1_i = V15_tmp7 + V15_tmp1;
}
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_aa71ab0d3045d39f0b6fb04ece3272c0_executor(__struct_compiled_op_aa71ab0d3045d39f0b6fb04ece3272c0* self) {
            return self->run();
        }

        static void __struct_compiled_op_aa71ab0d3045d39f0b6fb04ece3272c0_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_aa71ab0d3045d39f0b6fb04ece3272c0*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_aa71ab0d3045d39f0b6fb04ece3272c0* struct_ptr = new __struct_compiled_op_aa71ab0d3045d39f0b6fb04ece3272c0();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_aa71ab0d3045d39f0b6fb04ece3272c0_executor), struct_ptr, __struct_compiled_op_aa71ab0d3045d39f0b6fb04ece3272c0_destructor);
  return thunk; }
...
PyMODINIT_FUNC initaa71ab0d3045d39f0b6fb04ece3272c0(void){
   import_array();
   (void) Py_InitModule("aa71ab0d3045d39f0b6fb04ece3272c0", MyMethods);
}
