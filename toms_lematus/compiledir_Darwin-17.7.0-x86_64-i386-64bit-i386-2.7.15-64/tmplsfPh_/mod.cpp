...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_9992ba107bd33538fd9a60993a7807e0 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_9992ba107bd33538fd9a60993a7807e0() {
        ...
        ~__struct_compiled_op_9992ba107bd33538fd9a60993a7807e0(void) {
            cleanup();
        }
...
npy_int64& V1_i = *V1_iter;
                  ...
                  {
npy_int64 V17_tmp1;
V17_tmp1 = V7_i + V9_i + V11_i;
npy_int64 V17_tmp2;
V17_tmp2 = ((V13_i)<(V17_tmp1)? (V13_i): ((V17_tmp1)<=(V13_i)? (V17_tmp1): nan("")));
npy_int64 V17_tmp3;
V17_tmp3 = ((V15_i)>(V17_tmp2)? (V15_i): ((V17_tmp2)>=(V15_i)? (V17_tmp2): nan("")));
V1_i = V3_i ? V5_i : V17_tmp3;
}
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_9992ba107bd33538fd9a60993a7807e0_executor(__struct_compiled_op_9992ba107bd33538fd9a60993a7807e0* self) {
            return self->run();
        }

        static void __struct_compiled_op_9992ba107bd33538fd9a60993a7807e0_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_9992ba107bd33538fd9a60993a7807e0*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_9992ba107bd33538fd9a60993a7807e0* struct_ptr = new __struct_compiled_op_9992ba107bd33538fd9a60993a7807e0();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_9992ba107bd33538fd9a60993a7807e0_executor), struct_ptr, __struct_compiled_op_9992ba107bd33538fd9a60993a7807e0_destructor);
  return thunk; }
...
PyMODINIT_FUNC init9992ba107bd33538fd9a60993a7807e0(void){
   import_array();
   (void) Py_InitModule("9992ba107bd33538fd9a60993a7807e0", MyMethods);
}
