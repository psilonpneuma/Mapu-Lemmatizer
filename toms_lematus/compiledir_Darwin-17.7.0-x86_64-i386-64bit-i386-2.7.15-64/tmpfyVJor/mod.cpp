...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_6b60529013237579b9b376554d2c12e8 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_6b60529013237579b9b376554d2c12e8() {
        ...
        ~__struct_compiled_op_6b60529013237579b9b376554d2c12e8(void) {
            cleanup();
        }
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_6b60529013237579b9b376554d2c12e8_executor(__struct_compiled_op_6b60529013237579b9b376554d2c12e8* self) {
            return self->run();
        }

        static void __struct_compiled_op_6b60529013237579b9b376554d2c12e8_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_6b60529013237579b9b376554d2c12e8*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_6b60529013237579b9b376554d2c12e8* struct_ptr = new __struct_compiled_op_6b60529013237579b9b376554d2c12e8();
  if (struct_ptr->init( PyTuple_GET_ITEM(argtuple, 0),PyTuple_GET_ITEM(argtuple, 1),PyTuple_GET_ITEM(argtuple, 2) ) != 0) {
    delete struct_ptr;
    return NULL;
  }
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_6b60529013237579b9b376554d2c12e8_executor), struct_ptr, __struct_compiled_op_6b60529013237579b9b376554d2c12e8_destructor);
  return thunk; }
...
PyMODINIT_FUNC init6b60529013237579b9b376554d2c12e8(void){
   import_array();
   (void) Py_InitModule("6b60529013237579b9b376554d2c12e8", MyMethods);
}
