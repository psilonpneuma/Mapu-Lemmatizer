...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_9dfac6cba635cdcf85595725a5bcb7b3 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_9dfac6cba635cdcf85595725a5bcb7b3() {
        ...
        ~__struct_compiled_op_9dfac6cba635cdcf85595725a5bcb7b3(void) {
            cleanup();
        }
...
V9_tmp1 = V5_i + V5_i;
npy_bool V9_tmp2;
V9_tmp2 = (V9_tmp1 < V7_i);
npy_int64 V9_tmp3;
V9_tmp3 = V9_tmp2 ? V7_i : V9_tmp1;
V1_i = V3_i ? V9_tmp3 : V5_i;
}
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_9dfac6cba635cdcf85595725a5bcb7b3_executor(__struct_compiled_op_9dfac6cba635cdcf85595725a5bcb7b3* self) {
            return self->run();
        }

        static void __struct_compiled_op_9dfac6cba635cdcf85595725a5bcb7b3_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_9dfac6cba635cdcf85595725a5bcb7b3*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_9dfac6cba635cdcf85595725a5bcb7b3* struct_ptr = new __struct_compiled_op_9dfac6cba635cdcf85595725a5bcb7b3();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_9dfac6cba635cdcf85595725a5bcb7b3_executor), struct_ptr, __struct_compiled_op_9dfac6cba635cdcf85595725a5bcb7b3_destructor);
  return thunk; }
...
PyMODINIT_FUNC init9dfac6cba635cdcf85595725a5bcb7b3(void){
   import_array();
   (void) Py_InitModule("9dfac6cba635cdcf85595725a5bcb7b3", MyMethods);
}
