...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_a22678277efa44ac8051b111c5e71f03 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_a22678277efa44ac8051b111c5e71f03() {
        ...
        ~__struct_compiled_op_a22678277efa44ac8051b111c5e71f03(void) {
            cleanup();
        }
...
V13_tmp1 = (V3_i < V5_i);
npy_int64 V13_tmp2;
V13_tmp2 = V13_tmp1 ? V3_i : V5_i;
npy_int64 V13_tmp3;
V13_tmp3 = V13_tmp2 - V7_i;
npy_int64 V13_tmp4;
V13_tmp4 = V13_tmp3 - V9_i;
V1_i = V13_tmp4 + V11_i;
}
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_a22678277efa44ac8051b111c5e71f03_executor(__struct_compiled_op_a22678277efa44ac8051b111c5e71f03* self) {
            return self->run();
        }

        static void __struct_compiled_op_a22678277efa44ac8051b111c5e71f03_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_a22678277efa44ac8051b111c5e71f03*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_a22678277efa44ac8051b111c5e71f03* struct_ptr = new __struct_compiled_op_a22678277efa44ac8051b111c5e71f03();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_a22678277efa44ac8051b111c5e71f03_executor), struct_ptr, __struct_compiled_op_a22678277efa44ac8051b111c5e71f03_destructor);
  return thunk; }
...
PyMODINIT_FUNC inita22678277efa44ac8051b111c5e71f03(void){
   import_array();
   (void) Py_InitModule("a22678277efa44ac8051b111c5e71f03", MyMethods);
}
