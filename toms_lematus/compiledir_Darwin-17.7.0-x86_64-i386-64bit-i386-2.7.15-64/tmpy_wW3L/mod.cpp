...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_adb4d10836be218ee6dee3b16d66aef2 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_adb4d10836be218ee6dee3b16d66aef2() {
        ...
        ~__struct_compiled_op_adb4d10836be218ee6dee3b16d66aef2(void) {
            cleanup();
        }
...
// Op class Elemwise
        ...
        goto __label_13;}
                ...
                V11_jumpx_2 = -(0);
                //printf("V11_jumpx_2 is:");
                //std::cout << V11_jumpx_2 << std::endl;
            ...
            dtype_V11& V11_i = ((dtype_V11*) PyArray_DATA(V11))[0];
...
V13_tmp2 = (npy_float32)V13_tmp1;
npy_float32 V13_tmp3;
V13_tmp3 = V5_i * V13_tmp2;
V1_i = V3_i ? V13_tmp3 : V11_i;
}
;
                    }
    ...
    std::vector< std::pair<int, int> > V7_loops(3);
    std::vector< std::pair<int, int> >::iterator V7_loops_it = V7_loops.begin();
        ...
        ++V7_loops_it;
            ...
            V7_loops_it->first = abs(PyArray_STRIDES(V7)[2]);
            
        V7_loops_it->second = 2;
        ++V7_loops_it;
    ...
    int init_totals[3] = {1, V7_n1, V7_n2};
    ...
    V7_loops_it = V7_loops.begin();
        ...
        int TOTAL_2 = init_totals[V7_loops_it->second];
        ++V7_loops_it;
...
0, 0, 0
    ...
    std::vector< std::pair<int, int> >::reverse_iterator V7_loops_rit;
        ...
        V7_loops_rit = V7_loops.rbegin();
            int V3_stride_l2 = init_strides[0][V7_loops_rit->second];
            ++V7_loops_rit;
        ...
        V7_loops_rit = V7_loops.rbegin();
            int V5_stride_l2 = init_strides[1][V7_loops_rit->second];
            ++V7_loops_rit;
        ...
        V7_loops_rit = V7_loops.rbegin();
            int V7_stride_l2 = init_strides[2][V7_loops_rit->second];
            ++V7_loops_rit;
        ...
        V7_loops_rit = V7_loops.rbegin();
            int V9_stride_l2 = init_strides[3][V7_loops_rit->second];
            ++V7_loops_rit;
        ...
        V7_loops_rit = V7_loops.rbegin();
            int V11_stride_l2 = init_strides[4][V7_loops_rit->second];
            ++V7_loops_rit;
            
            int V11_stride_l1 = init_strides[4][V7_loops_rit->second];
            ++V7_loops_rit;
            
            int V11_stride_l0 = init_strides[4][V7_loops_rit->second];
            ++V7_loops_rit;
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_adb4d10836be218ee6dee3b16d66aef2_executor(__struct_compiled_op_adb4d10836be218ee6dee3b16d66aef2* self) {
            return self->run();
        }

        static void __struct_compiled_op_adb4d10836be218ee6dee3b16d66aef2_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_adb4d10836be218ee6dee3b16d66aef2*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_adb4d10836be218ee6dee3b16d66aef2* struct_ptr = new __struct_compiled_op_adb4d10836be218ee6dee3b16d66aef2();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_adb4d10836be218ee6dee3b16d66aef2_executor), struct_ptr, __struct_compiled_op_adb4d10836be218ee6dee3b16d66aef2_destructor);
  return thunk; }
...
PyMODINIT_FUNC initadb4d10836be218ee6dee3b16d66aef2(void){
   import_array();
   (void) Py_InitModule("adb4d10836be218ee6dee3b16d66aef2", MyMethods);
}
