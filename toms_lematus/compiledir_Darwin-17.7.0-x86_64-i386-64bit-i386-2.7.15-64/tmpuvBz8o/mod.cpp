...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_52ed923a679eedd66b1cf503e8366364 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_52ed923a679eedd66b1cf503e8366364() {
        ...
        ~__struct_compiled_op_52ed923a679eedd66b1cf503e8366364(void) {
            cleanup();
        }
...
V9_tmp1 = (V5_i < V7_i);
npy_int64 V9_tmp2;
V9_tmp2 = V9_tmp1 ? V5_i : V7_i;
npy_int64 V9_tmp3;
V9_tmp3 = V3_i - V9_tmp2;
V1_i = V9_tmp3 + V5_i;
}
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_52ed923a679eedd66b1cf503e8366364_executor(__struct_compiled_op_52ed923a679eedd66b1cf503e8366364* self) {
            return self->run();
        }

        static void __struct_compiled_op_52ed923a679eedd66b1cf503e8366364_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_52ed923a679eedd66b1cf503e8366364*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_52ed923a679eedd66b1cf503e8366364* struct_ptr = new __struct_compiled_op_52ed923a679eedd66b1cf503e8366364();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_52ed923a679eedd66b1cf503e8366364_executor), struct_ptr, __struct_compiled_op_52ed923a679eedd66b1cf503e8366364_destructor);
  return thunk; }
...
PyMODINIT_FUNC init52ed923a679eedd66b1cf503e8366364(void){
   import_array();
   (void) Py_InitModule("52ed923a679eedd66b1cf503e8366364", MyMethods);
}
