...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_73fcc63e6d58739357829d78bbc4569f {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_73fcc63e6d58739357829d78bbc4569f() {
        ...
        ~__struct_compiled_op_73fcc63e6d58739357829d78bbc4569f(void) {
            cleanup();
        }
        ...
        
{
    ...
    {Py_XINCREF(py_V19);}
        ...
        goto __label_20;}
            ...
            // This is a TypeError to be consistent with DEBUG_MODE
            // Note: DEBUG_MODE also tells the name of the container
            if (PyArray_TYPE((PyArrayObject*) py_V19) != NPY_INT8) {
                PyErr_Format(PyExc_TypeError,
                             "expected type_num %d (NPY_INT8) got %d",
                             NPY_INT8, PyArray_TYPE((PyArrayObject*) py_V19));
                {
        __failure = 20;
        if (!PyErr_Occurred()) {
            PyErr_SetString(PyExc_RuntimeError,
...
V19_iter = (npy_int8*)(PyArray_DATA(V19));
...
npy_int8& V19_i = *V19_iter;
npy_int64& V21_i = *V21_iter;

                  {
npy_int64 V23_tmp1;
{
npy_int64 V23_0_tmp1;
V23_0_tmp1 = V9_i - V11_i;
npy_int64 V23_0_tmp2;
V23_0_tmp2 = ((V23_0_tmp1)>(V7_i)? (V23_0_tmp1): ((V7_i)>=(V23_0_tmp1)? (V7_i): nan("")));
V23_tmp1 = V3_i ? V5_i : V23_0_tmp2;
}

npy_int64 V23_tmp2;
{
npy_int64 V23_1_tmp1;
V23_1_tmp1 = V13_i + V23_tmp1 + V15_i;
npy_bool V23_1_tmp2;
V23_1_tmp2 = (V23_tmp1 < V5_i);
npy_int64 V23_1_tmp3;
V23_1_tmp3 = V23_1_tmp1 - V17_i;
V23_tmp2 = V23_1_tmp2 ? V23_1_tmp3 : V23_tmp1;
}

npy_int64 V23_tmp3;
{
npy_bool V23_2_tmp1;
V23_2_tmp1 = (V23_tmp2 < V5_i);
V23_tmp3 = V23_2_tmp1 ? V19_i : V23_tmp2;
}

npy_int64 V23_tmp4;
{
npy_bool V23_3_tmp1;
V23_3_tmp1 = (V23_tmp3 >= V21_i);
V23_tmp4 = V23_3_tmp1 ? V21_i : V23_tmp3;
}

npy_bool V23_tmp5;
V23_tmp5 = (V23_tmp4 < V5_i);
V1_i = V23_tmp5 ? V5_i : V23_tmp4;
}
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_73fcc63e6d58739357829d78bbc4569f_executor(__struct_compiled_op_73fcc63e6d58739357829d78bbc4569f* self) {
            return self->run();
        }

        static void __struct_compiled_op_73fcc63e6d58739357829d78bbc4569f_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_73fcc63e6d58739357829d78bbc4569f*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_73fcc63e6d58739357829d78bbc4569f* struct_ptr = new __struct_compiled_op_73fcc63e6d58739357829d78bbc4569f();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_73fcc63e6d58739357829d78bbc4569f_executor), struct_ptr, __struct_compiled_op_73fcc63e6d58739357829d78bbc4569f_destructor);
  return thunk; }
...
PyMODINIT_FUNC init73fcc63e6d58739357829d78bbc4569f(void){
   import_array();
   (void) Py_InitModule("73fcc63e6d58739357829d78bbc4569f", MyMethods);
}
