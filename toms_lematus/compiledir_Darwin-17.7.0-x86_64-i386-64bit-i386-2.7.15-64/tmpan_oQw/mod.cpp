...
#define THEANO_MACRO_MOD(x,y) (x % y)
    ...
    namespace {
    struct __struct_compiled_op_9b3a55cd37feec65159452ac65df0303 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_9b3a55cd37feec65159452ac65df0303() {
        ...
        ~__struct_compiled_op_9b3a55cd37feec65159452ac65df0303(void) {
            cleanup();
        }
...
if (V7_tmp1 < 0) {
    if (V3_i < 0) {
        ...
        V1_i = - ((-V7_tmp1) / V3_i) - ((THEANO_MACRO_MOD((-V7_tmp1), V3_i) == 0) ? 0 : 1);
    }
} else {
    if (V3_i < 0) {
        V1_i = - (V7_tmp1 / (-V3_i)) - ((THEANO_MACRO_MOD(V7_tmp1, (-V3_i)) == 0) ? 0 : 1);
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_9b3a55cd37feec65159452ac65df0303_executor(__struct_compiled_op_9b3a55cd37feec65159452ac65df0303* self) {
            return self->run();
        }

        static void __struct_compiled_op_9b3a55cd37feec65159452ac65df0303_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_9b3a55cd37feec65159452ac65df0303*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_9b3a55cd37feec65159452ac65df0303* struct_ptr = new __struct_compiled_op_9b3a55cd37feec65159452ac65df0303();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_9b3a55cd37feec65159452ac65df0303_executor), struct_ptr, __struct_compiled_op_9b3a55cd37feec65159452ac65df0303_destructor);
  return thunk; }
...
PyMODINIT_FUNC init9b3a55cd37feec65159452ac65df0303(void){
   import_array();
   (void) Py_InitModule("9b3a55cd37feec65159452ac65df0303", MyMethods);
}
