...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_f9985bcefbb4a9c109a04f650eb16df5 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_f9985bcefbb4a9c109a04f650eb16df5() {
        ...
        ~__struct_compiled_op_f9985bcefbb4a9c109a04f650eb16df5(void) {
            cleanup();
        }
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_f9985bcefbb4a9c109a04f650eb16df5_executor(__struct_compiled_op_f9985bcefbb4a9c109a04f650eb16df5* self) {
            return self->run();
        }

        static void __struct_compiled_op_f9985bcefbb4a9c109a04f650eb16df5_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_f9985bcefbb4a9c109a04f650eb16df5*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_f9985bcefbb4a9c109a04f650eb16df5* struct_ptr = new __struct_compiled_op_f9985bcefbb4a9c109a04f650eb16df5();
  if (struct_ptr->init( PyTuple_GET_ITEM(argtuple, 0),PyTuple_GET_ITEM(argtuple, 1),PyTuple_GET_ITEM(argtuple, 2) ) != 0) {
    delete struct_ptr;
    return NULL;
  }
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_f9985bcefbb4a9c109a04f650eb16df5_executor), struct_ptr, __struct_compiled_op_f9985bcefbb4a9c109a04f650eb16df5_destructor);
  return thunk; }
...
PyMODINIT_FUNC initf9985bcefbb4a9c109a04f650eb16df5(void){
   import_array();
   (void) Py_InitModule("f9985bcefbb4a9c109a04f650eb16df5", MyMethods);
}
