...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_4a825710521256ea1ad62c60d5f39468 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_4a825710521256ea1ad62c60d5f39468() {
        ...
        ~__struct_compiled_op_4a825710521256ea1ad62c60d5f39468(void) {
            cleanup();
        }
...
V17_1_tmp1 = V5_i + V7_i + V9_i;
V17_tmp2 = V17_1_tmp1 - V11_i;
}

npy_int64 V17_tmp3;
V17_tmp3 = V17_tmp1 ? V15_i : V9_i;
npy_bool V17_tmp4;
V17_tmp4 = (V17_tmp2 < V13_i);
npy_int64 V17_tmp5;
V17_tmp5 = V17_tmp4 ? V13_i : V17_tmp2;
V1_i = V3_i ? V17_tmp5 : V17_tmp3;
}
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_4a825710521256ea1ad62c60d5f39468_executor(__struct_compiled_op_4a825710521256ea1ad62c60d5f39468* self) {
            return self->run();
        }

        static void __struct_compiled_op_4a825710521256ea1ad62c60d5f39468_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_4a825710521256ea1ad62c60d5f39468*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_4a825710521256ea1ad62c60d5f39468* struct_ptr = new __struct_compiled_op_4a825710521256ea1ad62c60d5f39468();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_4a825710521256ea1ad62c60d5f39468_executor), struct_ptr, __struct_compiled_op_4a825710521256ea1ad62c60d5f39468_destructor);
  return thunk; }
...
PyMODINIT_FUNC init4a825710521256ea1ad62c60d5f39468(void){
   import_array();
   (void) Py_InitModule("4a825710521256ea1ad62c60d5f39468", MyMethods);
}
