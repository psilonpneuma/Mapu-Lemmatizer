...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_fa5e41d326aa5b85357f4ee055f7c275 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_fa5e41d326aa5b85357f4ee055f7c275() {
        ...
        ~__struct_compiled_op_fa5e41d326aa5b85357f4ee055f7c275(void) {
            cleanup();
        }
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_fa5e41d326aa5b85357f4ee055f7c275_executor(__struct_compiled_op_fa5e41d326aa5b85357f4ee055f7c275* self) {
            return self->run();
        }

        static void __struct_compiled_op_fa5e41d326aa5b85357f4ee055f7c275_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_fa5e41d326aa5b85357f4ee055f7c275*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_fa5e41d326aa5b85357f4ee055f7c275* struct_ptr = new __struct_compiled_op_fa5e41d326aa5b85357f4ee055f7c275();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_fa5e41d326aa5b85357f4ee055f7c275_executor), struct_ptr, __struct_compiled_op_fa5e41d326aa5b85357f4ee055f7c275_destructor);
  return thunk; }
...
PyMODINIT_FUNC initfa5e41d326aa5b85357f4ee055f7c275(void){
   import_array();
   (void) Py_InitModule("fa5e41d326aa5b85357f4ee055f7c275", MyMethods);
}
