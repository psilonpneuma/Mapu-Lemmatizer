...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_914395707a9be715435ec2c8cf8984cb {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_914395707a9be715435ec2c8cf8984cb() {
        ...
        ~__struct_compiled_op_914395707a9be715435ec2c8cf8984cb(void) {
            cleanup();
        }
...
npy_int64 V11_tmp1;
{
npy_int64 V11_0_tmp1;
V11_0_tmp1 = V3_i + V7_i;
npy_bool V11_0_tmp2;
V11_0_tmp2 = (V3_i < V5_i);
V11_tmp1 = V11_0_tmp2 ? V11_0_tmp1 : V3_i;
}

npy_int64 V11_tmp2;
{
npy_bool V11_1_tmp1;
V11_1_tmp1 = (V11_tmp1 < V5_i);
V11_tmp2 = V11_1_tmp1 ? V5_i : V11_tmp1;
}

npy_int64 V11_tmp3;
{
npy_bool V11_2_tmp1;
V11_2_tmp1 = (V11_tmp2 >= V7_i);
V11_tmp3 = V11_2_tmp1 ? V7_i : V11_tmp2;
}

npy_int64 V11_tmp4;
{
npy_bool V11_3_tmp1;
V11_3_tmp1 = (V11_tmp3 < V5_i);
V11_tmp4 = V11_3_tmp1 ? V5_i : V11_tmp3;
}

npy_bool V11_tmp5;
V11_tmp5 = (V11_tmp4 < V9_i);
V1_i = V11_tmp5 ? V11_tmp4 : V9_i;
}
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_914395707a9be715435ec2c8cf8984cb_executor(__struct_compiled_op_914395707a9be715435ec2c8cf8984cb* self) {
            return self->run();
        }

        static void __struct_compiled_op_914395707a9be715435ec2c8cf8984cb_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_914395707a9be715435ec2c8cf8984cb*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_914395707a9be715435ec2c8cf8984cb* struct_ptr = new __struct_compiled_op_914395707a9be715435ec2c8cf8984cb();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_914395707a9be715435ec2c8cf8984cb_executor), struct_ptr, __struct_compiled_op_914395707a9be715435ec2c8cf8984cb_destructor);
  return thunk; }
...
PyMODINIT_FUNC init914395707a9be715435ec2c8cf8984cb(void){
   import_array();
   (void) Py_InitModule("914395707a9be715435ec2c8cf8984cb", MyMethods);
}
