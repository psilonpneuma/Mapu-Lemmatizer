...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_6adf09bf6ca297e2285e17127feb16bd {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_6adf09bf6ca297e2285e17127feb16bd() {
        ...
        ~__struct_compiled_op_6adf09bf6ca297e2285e17127feb16bd(void) {
            cleanup();
        }
...
PyArrayObject * xview = NULL;
        if (PyArray_NDIM(V3) != 0){
            PyErr_SetString(PyExc_ValueError,
                                     "Expected 0 dimensions input"
                                        );
            {
        __failure = 5;
        if (!PyErr_Occurred()) {
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_6adf09bf6ca297e2285e17127feb16bd_executor(__struct_compiled_op_6adf09bf6ca297e2285e17127feb16bd* self) {
            return self->run();
        }

        static void __struct_compiled_op_6adf09bf6ca297e2285e17127feb16bd_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_6adf09bf6ca297e2285e17127feb16bd*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_6adf09bf6ca297e2285e17127feb16bd* struct_ptr = new __struct_compiled_op_6adf09bf6ca297e2285e17127feb16bd();
  if (struct_ptr->init( PyTuple_GET_ITEM(argtuple, 0),PyTuple_GET_ITEM(argtuple, 1),PyTuple_GET_ITEM(argtuple, 2) ) != 0) {
    delete struct_ptr;
    return NULL;
  }
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_6adf09bf6ca297e2285e17127feb16bd_executor), struct_ptr, __struct_compiled_op_6adf09bf6ca297e2285e17127feb16bd_destructor);
  return thunk; }
...
PyMODINIT_FUNC init6adf09bf6ca297e2285e17127feb16bd(void){
   import_array();
   (void) Py_InitModule("6adf09bf6ca297e2285e17127feb16bd", MyMethods);
}
