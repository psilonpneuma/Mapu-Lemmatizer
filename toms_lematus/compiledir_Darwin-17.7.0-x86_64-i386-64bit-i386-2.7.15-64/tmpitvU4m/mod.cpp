...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_3ebefd3a7b411320aa72e4fe63bae553 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_3ebefd3a7b411320aa72e4fe63bae553() {
        ...
        ~__struct_compiled_op_3ebefd3a7b411320aa72e4fe63bae553(void) {
            cleanup();
        }
...
npy_int64& V1_i = *V1_iter;
                  ...
                  {
npy_int64 V11_tmp1;
V11_tmp1 = ((V5_i)>(V3_i)? (V5_i): ((V3_i)>=(V5_i)? (V3_i): nan("")));
npy_int64 V11_tmp2;
V11_tmp2 = V11_tmp1 - V7_i;
npy_int64 V11_tmp3;
V11_tmp3 = V11_tmp1 + V9_i;
npy_bool V11_tmp4;
V11_tmp4 = (V11_tmp1 < V7_i);
npy_int64 V11_tmp5;
V11_tmp5 = V11_tmp4 ? V11_tmp3 : V11_tmp2;
V1_i = V11_tmp5 + V9_i;
}
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_3ebefd3a7b411320aa72e4fe63bae553_executor(__struct_compiled_op_3ebefd3a7b411320aa72e4fe63bae553* self) {
            return self->run();
        }

        static void __struct_compiled_op_3ebefd3a7b411320aa72e4fe63bae553_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_3ebefd3a7b411320aa72e4fe63bae553*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_3ebefd3a7b411320aa72e4fe63bae553* struct_ptr = new __struct_compiled_op_3ebefd3a7b411320aa72e4fe63bae553();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_3ebefd3a7b411320aa72e4fe63bae553_executor), struct_ptr, __struct_compiled_op_3ebefd3a7b411320aa72e4fe63bae553_destructor);
  return thunk; }
...
PyMODINIT_FUNC init3ebefd3a7b411320aa72e4fe63bae553(void){
   import_array();
   (void) Py_InitModule("3ebefd3a7b411320aa72e4fe63bae553", MyMethods);
}
