...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_45b4ebe289ceafdff5055ed6b23bfe80 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_45b4ebe289ceafdff5055ed6b23bfe80() {
        ...
        ~__struct_compiled_op_45b4ebe289ceafdff5055ed6b23bfe80(void) {
            cleanup();
        }
...
V13_0_tmp1 = ((V9_i)<(V7_i)? (V9_i): ((V7_i)<=(V9_i)? (V7_i): nan("")));
V13_tmp1 = V3_i ? V5_i : V13_0_tmp1;
}

npy_int64 V13_tmp2;
{
npy_int64 V13_1_tmp1;
V13_1_tmp1 = V13_tmp1 + V9_i;
npy_bool V13_1_tmp2;
V13_1_tmp2 = (V13_tmp1 < V5_i);
V13_tmp2 = V13_1_tmp2 ? V13_1_tmp1 : V13_tmp1;
}

npy_int64 V13_tmp3;
{
npy_bool V13_2_tmp1;
V13_2_tmp1 = (V13_tmp2 < V5_i);
V13_tmp3 = V13_2_tmp1 ? V11_i : V13_tmp2;
}

npy_int64 V13_tmp4;
{
npy_bool V13_3_tmp1;
V13_3_tmp1 = (V13_tmp3 >= V9_i);
V13_tmp4 = V13_3_tmp1 ? V9_i : V13_tmp3;
}

npy_bool V13_tmp5;
V13_tmp5 = (V13_tmp4 < V5_i);
V1_i = V13_tmp5 ? V5_i : V13_tmp4;
}
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_45b4ebe289ceafdff5055ed6b23bfe80_executor(__struct_compiled_op_45b4ebe289ceafdff5055ed6b23bfe80* self) {
            return self->run();
        }

        static void __struct_compiled_op_45b4ebe289ceafdff5055ed6b23bfe80_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_45b4ebe289ceafdff5055ed6b23bfe80*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_45b4ebe289ceafdff5055ed6b23bfe80* struct_ptr = new __struct_compiled_op_45b4ebe289ceafdff5055ed6b23bfe80();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_45b4ebe289ceafdff5055ed6b23bfe80_executor), struct_ptr, __struct_compiled_op_45b4ebe289ceafdff5055ed6b23bfe80_destructor);
  return thunk; }
...
PyMODINIT_FUNC init45b4ebe289ceafdff5055ed6b23bfe80(void){
   import_array();
   (void) Py_InitModule("45b4ebe289ceafdff5055ed6b23bfe80", MyMethods);
}
