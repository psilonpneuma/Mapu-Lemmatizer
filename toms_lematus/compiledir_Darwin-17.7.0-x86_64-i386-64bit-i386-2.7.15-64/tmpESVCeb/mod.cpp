...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_03711f2d3a1e1525951cb54a359a3e6b {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_03711f2d3a1e1525951cb54a359a3e6b() {
        ...
        ~__struct_compiled_op_03711f2d3a1e1525951cb54a359a3e6b(void) {
            cleanup();
        }
...
// Op class MakeVector
        ...
        if(!V1 || PyArray_DIMS(V1)[0] != 3){
            ...
            *((npy_int64 *)PyArray_GETPTR1(V1, 2)) = *((npy_int64 *) PyArray_DATA(V7));
            __label_9:
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_03711f2d3a1e1525951cb54a359a3e6b_executor(__struct_compiled_op_03711f2d3a1e1525951cb54a359a3e6b* self) {
            return self->run();
        }

        static void __struct_compiled_op_03711f2d3a1e1525951cb54a359a3e6b_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_03711f2d3a1e1525951cb54a359a3e6b*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_03711f2d3a1e1525951cb54a359a3e6b* struct_ptr = new __struct_compiled_op_03711f2d3a1e1525951cb54a359a3e6b();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_03711f2d3a1e1525951cb54a359a3e6b_executor), struct_ptr, __struct_compiled_op_03711f2d3a1e1525951cb54a359a3e6b_destructor);
  return thunk; }
...
PyMODINIT_FUNC init03711f2d3a1e1525951cb54a359a3e6b(void){
   import_array();
   (void) Py_InitModule("03711f2d3a1e1525951cb54a359a3e6b", MyMethods);
}
