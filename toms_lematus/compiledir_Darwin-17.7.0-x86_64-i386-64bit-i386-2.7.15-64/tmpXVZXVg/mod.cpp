...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_0cd2acd595927c08114f36f8d1b5e7a0 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_0cd2acd595927c08114f36f8d1b5e7a0() {
        ...
        ~__struct_compiled_op_0cd2acd595927c08114f36f8d1b5e7a0(void) {
            cleanup();
        }
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_0cd2acd595927c08114f36f8d1b5e7a0_executor(__struct_compiled_op_0cd2acd595927c08114f36f8d1b5e7a0* self) {
            return self->run();
        }

        static void __struct_compiled_op_0cd2acd595927c08114f36f8d1b5e7a0_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_0cd2acd595927c08114f36f8d1b5e7a0*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_0cd2acd595927c08114f36f8d1b5e7a0* struct_ptr = new __struct_compiled_op_0cd2acd595927c08114f36f8d1b5e7a0();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_0cd2acd595927c08114f36f8d1b5e7a0_executor), struct_ptr, __struct_compiled_op_0cd2acd595927c08114f36f8d1b5e7a0_destructor);
  return thunk; }
...
PyMODINIT_FUNC init0cd2acd595927c08114f36f8d1b5e7a0(void){
   import_array();
   (void) Py_InitModule("0cd2acd595927c08114f36f8d1b5e7a0", MyMethods);
}
