...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_df55764600dce562f3fee56282f35e0a {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_df55764600dce562f3fee56282f35e0a() {
        ...
        ~__struct_compiled_op_df55764600dce562f3fee56282f35e0a(void) {
            cleanup();
        }
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_df55764600dce562f3fee56282f35e0a_executor(__struct_compiled_op_df55764600dce562f3fee56282f35e0a* self) {
            return self->run();
        }

        static void __struct_compiled_op_df55764600dce562f3fee56282f35e0a_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_df55764600dce562f3fee56282f35e0a*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_df55764600dce562f3fee56282f35e0a* struct_ptr = new __struct_compiled_op_df55764600dce562f3fee56282f35e0a();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_df55764600dce562f3fee56282f35e0a_executor), struct_ptr, __struct_compiled_op_df55764600dce562f3fee56282f35e0a_destructor);
  return thunk; }
...
PyMODINIT_FUNC initdf55764600dce562f3fee56282f35e0a(void){
   import_array();
   (void) Py_InitModule("df55764600dce562f3fee56282f35e0a", MyMethods);
}
