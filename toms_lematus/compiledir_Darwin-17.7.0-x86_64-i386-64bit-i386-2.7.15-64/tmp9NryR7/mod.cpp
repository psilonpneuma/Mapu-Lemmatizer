...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_00829c3fef2372d948f894e5a55db272 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_00829c3fef2372d948f894e5a55db272() {
        ...
        ~__struct_compiled_op_00829c3fef2372d948f894e5a55db272(void) {
            cleanup();
        }
...
V17_0_tmp1 = V5_i + V7_i + V9_i;
V17_tmp1 = V3_i - V17_0_tmp1;
}

npy_int64 V17_tmp2;
{
npy_int64 V17_1_tmp1;
V17_1_tmp1 = V13_i - V15_i;
npy_bool V17_1_tmp2;
V17_1_tmp2 = (V17_tmp1 < V11_i);
V17_tmp2 = V17_1_tmp2 ? V17_1_tmp1 : V17_tmp1;
}

npy_int64 V17_tmp3;
{
npy_bool V17_2_tmp1;
V17_2_tmp1 = (V17_tmp2 < V11_i);
V17_tmp3 = V17_2_tmp1 ? V11_i : V17_tmp2;
}

npy_bool V17_tmp4;
V17_tmp4 = (V17_tmp3 < V9_i);
V1_i = V17_tmp4 ? V17_tmp3 : V9_i;
}
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_00829c3fef2372d948f894e5a55db272_executor(__struct_compiled_op_00829c3fef2372d948f894e5a55db272* self) {
            return self->run();
        }

        static void __struct_compiled_op_00829c3fef2372d948f894e5a55db272_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_00829c3fef2372d948f894e5a55db272*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_00829c3fef2372d948f894e5a55db272* struct_ptr = new __struct_compiled_op_00829c3fef2372d948f894e5a55db272();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_00829c3fef2372d948f894e5a55db272_executor), struct_ptr, __struct_compiled_op_00829c3fef2372d948f894e5a55db272_destructor);
  return thunk; }
...
PyMODINIT_FUNC init00829c3fef2372d948f894e5a55db272(void){
   import_array();
   (void) Py_InitModule("00829c3fef2372d948f894e5a55db272", MyMethods);
}
