...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_c020ace3ddd8f96ea78d30f7e63eb28f {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_c020ace3ddd8f96ea78d30f7e63eb28f() {
        ...
        ~__struct_compiled_op_c020ace3ddd8f96ea78d30f7e63eb28f(void) {
            cleanup();
        }
...
npy_int64& V21_i = *V21_iter;
                  ...
                  {
npy_int64 V23_tmp1;
V23_tmp1 = V7_i + V9_i + V11_i;
npy_int64 V23_tmp2;
V23_tmp2 = V15_i + V17_i;
npy_bool V23_tmp3;
V23_tmp3 = (V13_i > V5_i);
npy_int64 V23_tmp4;
V23_tmp4 = ((V21_i)<(V23_tmp1)? (V21_i): ((V23_tmp1)<=(V21_i)? (V23_tmp1): nan("")));
npy_bool V23_tmp5;
V23_tmp5 = (V23_tmp1 < V5_i);
npy_int64 V23_tmp6;
V23_tmp6 = V23_tmp2 - V19_i;
npy_bool V23_tmp7;
V23_tmp7 = (V23_tmp5 & V23_tmp3);
npy_int64 V23_tmp8;
V23_tmp8 = V23_tmp7 ? V23_tmp6 : V23_tmp4;
V1_i = V3_i ? V5_i : V23_tmp8;
}
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_c020ace3ddd8f96ea78d30f7e63eb28f_executor(__struct_compiled_op_c020ace3ddd8f96ea78d30f7e63eb28f* self) {
            return self->run();
        }

        static void __struct_compiled_op_c020ace3ddd8f96ea78d30f7e63eb28f_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_c020ace3ddd8f96ea78d30f7e63eb28f*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_c020ace3ddd8f96ea78d30f7e63eb28f* struct_ptr = new __struct_compiled_op_c020ace3ddd8f96ea78d30f7e63eb28f();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_c020ace3ddd8f96ea78d30f7e63eb28f_executor), struct_ptr, __struct_compiled_op_c020ace3ddd8f96ea78d30f7e63eb28f_destructor);
  return thunk; }
...
PyMODINIT_FUNC initc020ace3ddd8f96ea78d30f7e63eb28f(void){
   import_array();
   (void) Py_InitModule("c020ace3ddd8f96ea78d30f7e63eb28f", MyMethods);
}
