...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_a677241784f45f12be82d3a83de6bbd8 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_a677241784f45f12be82d3a83de6bbd8() {
        ...
        ~__struct_compiled_op_a677241784f45f12be82d3a83de6bbd8(void) {
            cleanup();
        }
...
dims[1] = V3_n2;
        ...
        goto __label_5;}
                ...
                V1_jumpx_2 = -(0);
                //printf("V1_jumpx_2 is:");
                //std::cout << V1_jumpx_2 << std::endl;
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_a677241784f45f12be82d3a83de6bbd8_executor(__struct_compiled_op_a677241784f45f12be82d3a83de6bbd8* self) {
            return self->run();
        }

        static void __struct_compiled_op_a677241784f45f12be82d3a83de6bbd8_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_a677241784f45f12be82d3a83de6bbd8*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_a677241784f45f12be82d3a83de6bbd8* struct_ptr = new __struct_compiled_op_a677241784f45f12be82d3a83de6bbd8();
  if (struct_ptr->init( PyTuple_GET_ITEM(argtuple, 0),PyTuple_GET_ITEM(argtuple, 1),PyTuple_GET_ITEM(argtuple, 2) ) != 0) {
    delete struct_ptr;
    return NULL;
  }
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_a677241784f45f12be82d3a83de6bbd8_executor), struct_ptr, __struct_compiled_op_a677241784f45f12be82d3a83de6bbd8_destructor);
  return thunk; }
...
PyMODINIT_FUNC inita677241784f45f12be82d3a83de6bbd8(void){
   import_array();
   (void) Py_InitModule("a677241784f45f12be82d3a83de6bbd8", MyMethods);
}
