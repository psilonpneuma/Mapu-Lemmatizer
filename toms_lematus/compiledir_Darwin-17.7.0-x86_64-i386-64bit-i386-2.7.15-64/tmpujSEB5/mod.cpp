...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_fcb714dd0dcb989c67c8e1c880a97960 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_fcb714dd0dcb989c67c8e1c880a97960() {
        ...
        ~__struct_compiled_op_fcb714dd0dcb989c67c8e1c880a97960(void) {
            cleanup();
        }
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_fcb714dd0dcb989c67c8e1c880a97960_executor(__struct_compiled_op_fcb714dd0dcb989c67c8e1c880a97960* self) {
            return self->run();
        }

        static void __struct_compiled_op_fcb714dd0dcb989c67c8e1c880a97960_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_fcb714dd0dcb989c67c8e1c880a97960*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_fcb714dd0dcb989c67c8e1c880a97960* struct_ptr = new __struct_compiled_op_fcb714dd0dcb989c67c8e1c880a97960();
  if (struct_ptr->init( PyTuple_GET_ITEM(argtuple, 0),PyTuple_GET_ITEM(argtuple, 1),PyTuple_GET_ITEM(argtuple, 2) ) != 0) {
    delete struct_ptr;
    return NULL;
  }
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_fcb714dd0dcb989c67c8e1c880a97960_executor), struct_ptr, __struct_compiled_op_fcb714dd0dcb989c67c8e1c880a97960_destructor);
  return thunk; }
...
PyMODINIT_FUNC initfcb714dd0dcb989c67c8e1c880a97960(void){
   import_array();
   (void) Py_InitModule("fcb714dd0dcb989c67c8e1c880a97960", MyMethods);
}
