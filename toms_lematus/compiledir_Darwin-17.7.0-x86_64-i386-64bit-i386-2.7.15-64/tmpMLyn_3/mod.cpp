...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_5d6cf65a13f2659c6210e20b67a9a073 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_5d6cf65a13f2659c6210e20b67a9a073() {
        ...
        ~__struct_compiled_op_5d6cf65a13f2659c6210e20b67a9a073(void) {
            cleanup();
        }
        ...
        
{
    ...
    {Py_XINCREF(py_V5);}
        ...
        goto __label_6;}
            ...
            // This is a TypeError to be consistent with DEBUG_MODE
            // Note: DEBUG_MODE also tells the name of the container
            if (PyArray_TYPE((PyArrayObject*) py_V5) != NPY_INT16) {
                PyErr_Format(PyExc_TypeError,
                             "expected type_num %d (NPY_INT16) got %d",
                             NPY_INT16, PyArray_TYPE((PyArrayObject*) py_V5));
                {
        __failure = 6;
        if (!PyErr_Occurred()) {
            PyErr_SetString(PyExc_RuntimeError,
...
// Op class Alloc
            ...
            npy_intp shape[4];
                ...
                shape[2] = ((dtype_V9*) PyArray_DATA(V9))[0];
                
                shape[3] = ((dtype_V11*) PyArray_DATA(V11))[0];
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_5d6cf65a13f2659c6210e20b67a9a073_executor(__struct_compiled_op_5d6cf65a13f2659c6210e20b67a9a073* self) {
            return self->run();
        }

        static void __struct_compiled_op_5d6cf65a13f2659c6210e20b67a9a073_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_5d6cf65a13f2659c6210e20b67a9a073*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_5d6cf65a13f2659c6210e20b67a9a073* struct_ptr = new __struct_compiled_op_5d6cf65a13f2659c6210e20b67a9a073();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_5d6cf65a13f2659c6210e20b67a9a073_executor), struct_ptr, __struct_compiled_op_5d6cf65a13f2659c6210e20b67a9a073_destructor);
  return thunk; }
...
PyMODINIT_FUNC init5d6cf65a13f2659c6210e20b67a9a073(void){
   import_array();
   (void) Py_InitModule("5d6cf65a13f2659c6210e20b67a9a073", MyMethods);
}
