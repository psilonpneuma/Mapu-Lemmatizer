...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_a1471857cb4c25a2652a96dba7c68462 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_a1471857cb4c25a2652a96dba7c68462() {
        ...
        ~__struct_compiled_op_a1471857cb4c25a2652a96dba7c68462(void) {
            cleanup();
        }
...
V13_tmp3 = V13_2_tmp1 ? V5_i : V13_tmp2;
}
...
{
npy_bool V13_4_tmp1;
V13_4_tmp1 = (V13_tmp4 < V5_i);
V13_tmp5 = V13_4_tmp1 ? V5_i : V13_tmp4;
}

npy_bool V13_tmp6;
V13_tmp6 = (V13_tmp5 < V11_i);
V1_i = V13_tmp6 ? V13_tmp5 : V11_i;
}
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_a1471857cb4c25a2652a96dba7c68462_executor(__struct_compiled_op_a1471857cb4c25a2652a96dba7c68462* self) {
            return self->run();
        }

        static void __struct_compiled_op_a1471857cb4c25a2652a96dba7c68462_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_a1471857cb4c25a2652a96dba7c68462*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_a1471857cb4c25a2652a96dba7c68462* struct_ptr = new __struct_compiled_op_a1471857cb4c25a2652a96dba7c68462();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_a1471857cb4c25a2652a96dba7c68462_executor), struct_ptr, __struct_compiled_op_a1471857cb4c25a2652a96dba7c68462_destructor);
  return thunk; }
...
PyMODINIT_FUNC inita1471857cb4c25a2652a96dba7c68462(void){
   import_array();
   (void) Py_InitModule("a1471857cb4c25a2652a96dba7c68462", MyMethods);
}
