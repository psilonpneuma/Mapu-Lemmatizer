...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_69f13cfa98203b2f25b9e5b899645fe0 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_69f13cfa98203b2f25b9e5b899645fe0() {
        ...
        ~__struct_compiled_op_69f13cfa98203b2f25b9e5b899645fe0(void) {
            cleanup();
        }
...
npy_int64& V1_i = *V1_iter;
                  ...
                  V1_i = ((V5_i)<(V3_i)? (V5_i): ((V3_i)<=(V5_i)? (V3_i): nan("")));
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_69f13cfa98203b2f25b9e5b899645fe0_executor(__struct_compiled_op_69f13cfa98203b2f25b9e5b899645fe0* self) {
            return self->run();
        }

        static void __struct_compiled_op_69f13cfa98203b2f25b9e5b899645fe0_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_69f13cfa98203b2f25b9e5b899645fe0*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_69f13cfa98203b2f25b9e5b899645fe0* struct_ptr = new __struct_compiled_op_69f13cfa98203b2f25b9e5b899645fe0();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_69f13cfa98203b2f25b9e5b899645fe0_executor), struct_ptr, __struct_compiled_op_69f13cfa98203b2f25b9e5b899645fe0_destructor);
  return thunk; }
...
PyMODINIT_FUNC init69f13cfa98203b2f25b9e5b899645fe0(void){
   import_array();
   (void) Py_InitModule("69f13cfa98203b2f25b9e5b899645fe0", MyMethods);
}
