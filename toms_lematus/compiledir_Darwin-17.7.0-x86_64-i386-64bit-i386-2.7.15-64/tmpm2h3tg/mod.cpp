...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_f34b2a5463a352dfe5d9ee01fcb97732 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_f34b2a5463a352dfe5d9ee01fcb97732() {
        ...
        ~__struct_compiled_op_f34b2a5463a352dfe5d9ee01fcb97732(void) {
            cleanup();
        }
...
V11_tmp1 = V3_i + V5_i + V7_i;
npy_float32 V11_tmp2;
V11_tmp2 = tanh(V11_tmp1);
V1_i = V11_tmp2 * V9_i;
}
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_f34b2a5463a352dfe5d9ee01fcb97732_executor(__struct_compiled_op_f34b2a5463a352dfe5d9ee01fcb97732* self) {
            return self->run();
        }

        static void __struct_compiled_op_f34b2a5463a352dfe5d9ee01fcb97732_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_f34b2a5463a352dfe5d9ee01fcb97732*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_f34b2a5463a352dfe5d9ee01fcb97732* struct_ptr = new __struct_compiled_op_f34b2a5463a352dfe5d9ee01fcb97732();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_f34b2a5463a352dfe5d9ee01fcb97732_executor), struct_ptr, __struct_compiled_op_f34b2a5463a352dfe5d9ee01fcb97732_destructor);
  return thunk; }
...
PyMODINIT_FUNC initf34b2a5463a352dfe5d9ee01fcb97732(void){
   import_array();
   (void) Py_InitModule("f34b2a5463a352dfe5d9ee01fcb97732", MyMethods);
}
