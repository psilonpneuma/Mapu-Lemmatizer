...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_8f07f7692e7e26509f272f8fd608c739 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_8f07f7692e7e26509f272f8fd608c739() {
        ...
        ~__struct_compiled_op_8f07f7692e7e26509f272f8fd608c739(void) {
            cleanup();
        }
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_8f07f7692e7e26509f272f8fd608c739_executor(__struct_compiled_op_8f07f7692e7e26509f272f8fd608c739* self) {
            return self->run();
        }

        static void __struct_compiled_op_8f07f7692e7e26509f272f8fd608c739_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_8f07f7692e7e26509f272f8fd608c739*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_8f07f7692e7e26509f272f8fd608c739* struct_ptr = new __struct_compiled_op_8f07f7692e7e26509f272f8fd608c739();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_8f07f7692e7e26509f272f8fd608c739_executor), struct_ptr, __struct_compiled_op_8f07f7692e7e26509f272f8fd608c739_destructor);
  return thunk; }
...
PyMODINIT_FUNC init8f07f7692e7e26509f272f8fd608c739(void){
   import_array();
   (void) Py_InitModule("8f07f7692e7e26509f272f8fd608c739", MyMethods);
}
