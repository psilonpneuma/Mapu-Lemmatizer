...
#define THEANO_MACRO_MOD(x,y) (x % y)
    ...
    namespace {
    struct __struct_compiled_op_1671e3fbd8ec9d691ed0580b482ab504 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_1671e3fbd8ec9d691ed0580b482ab504() {
        ...
        ~__struct_compiled_op_1671e3fbd8ec9d691ed0580b482ab504(void) {
            cleanup();
        }

        int init(PyObject* __ERROR, PyObject* storage_V3, PyObject* storage_V5, PyObject* storage_V7, PyObject* storage_V9, PyObject* storage_V11, PyObject* storage_V13, PyObject* storage_V15, PyObject* storage_V17, PyObject* storage_V19, PyObject* storage_V21, PyObject* storage_V1) {
...
npy_int64 V23_tmp2;
{
npy_int64 V23_1_tmp1;
V23_1_tmp1 = V7_i + V11_i;
npy_bool V23_1_tmp2;
V23_1_tmp2 = (V7_i < V9_i);
V23_tmp2 = V23_1_tmp2 ? V23_1_tmp1 : V7_i;
}

npy_int64 V23_tmp3;
{
npy_bool V23_2_tmp1;
V23_2_tmp1 = (V23_tmp2 < V9_i);
V23_tmp3 = V23_2_tmp1 ? V13_i : V23_tmp2;
}

npy_int64 V23_tmp4;
{
npy_bool V23_3_tmp1;
V23_3_tmp1 = (V23_tmp3 >= V11_i);
npy_int64 V23_3_tmp2;
V23_3_tmp2 = V23_3_tmp1 ? V11_i : V23_tmp3;
npy_int64 V23_3_tmp3;
V23_3_tmp3 = V3_i - V23_3_tmp2;
npy_int64 V23_3_tmp4;
V23_3_tmp4 = V23_3_tmp3 - V5_i;
npy_int64 V23_3_tmp5;

if (V23_3_tmp4 < 0) {
    if (V15_i < 0) {
        V23_3_tmp5 = ((-V23_3_tmp4) / (-V15_i));
    } else {
        V23_3_tmp5 = - ((-V23_3_tmp4) / V15_i) - ((THEANO_MACRO_MOD((-V23_3_tmp4), V15_i) == 0) ? 0 : 1);
    }
} else {
    if (V15_i < 0) {
        V23_3_tmp5 = - (V23_3_tmp4 / (-V15_i)) - ((THEANO_MACRO_MOD(V23_3_tmp4, (-V15_i)) == 0) ? 0 : 1);
...
V23_tmp4 = V23_3_tmp5 + V5_i;
}

npy_int64 V23_tmp5;
{
npy_bool V23_4_tmp1;
V23_4_tmp1 = (V23_tmp4 < V9_i);
npy_int64 V23_4_tmp2;
V23_4_tmp2 = V23_4_tmp1 ? V9_i : V23_tmp4;
npy_int64 V23_4_tmp3;
V23_4_tmp3 = V23_4_tmp2 - V5_i;
npy_int64 V23_4_tmp4;
V23_4_tmp4 = V23_tmp1 - V23_4_tmp3;
V23_tmp5 = V23_4_tmp4 - V5_i;
}

npy_int64 V23_tmp6;
{
npy_int64 V23_5_tmp1;
V23_5_tmp1 = V23_tmp1 - V5_i;
npy_bool V23_5_tmp2;
V23_5_tmp2 = (V23_tmp5 < V9_i);
V23_tmp6 = V23_5_tmp2 ? V23_5_tmp1 : V23_tmp5;
}

npy_int64 V23_tmp7;
{
npy_bool V23_6_tmp1;
V23_6_tmp1 = (V23_tmp6 < V9_i);
V23_tmp7 = V23_6_tmp1 ? V9_i : V23_tmp6;
}

npy_bool V23_tmp8;
V23_tmp8 = (V23_tmp7 < V17_i);
npy_int64 V23_tmp9;
V23_tmp9 = V23_tmp8 ? V23_tmp7 : V17_i;
npy_int64 V23_tmp10;
V23_tmp10 = V23_tmp9 - V19_i;
npy_int64 V23_tmp11;
V23_tmp11 = V23_tmp10 - V5_i;
V1_i = V23_tmp11 + V21_i;
}
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_1671e3fbd8ec9d691ed0580b482ab504_executor(__struct_compiled_op_1671e3fbd8ec9d691ed0580b482ab504* self) {
            return self->run();
        }

        static void __struct_compiled_op_1671e3fbd8ec9d691ed0580b482ab504_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_1671e3fbd8ec9d691ed0580b482ab504*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  if (12 != PyTuple_Size(argtuple)){ 
     PyErr_Format(PyExc_TypeError, "Wrong number of arguments, expected 12, got %i", (int)PyTuple_Size(argtuple));
     return NULL;
  }
  __struct_compiled_op_1671e3fbd8ec9d691ed0580b482ab504* struct_ptr = new __struct_compiled_op_1671e3fbd8ec9d691ed0580b482ab504();
  if (struct_ptr->init( PyTuple_GET_ITEM(argtuple, 0),PyTuple_GET_ITEM(argtuple, 1),PyTuple_GET_ITEM(argtuple, 2),PyTuple_GET_ITEM(argtuple, 3),PyTuple_GET_ITEM(argtuple, 4),PyTuple_GET_ITEM(argtuple, 5),PyTuple_GET_ITEM(argtuple, 6),PyTuple_GET_ITEM(argtuple, 7),PyTuple_GET_ITEM(argtuple, 8),PyTuple_GET_ITEM(argtuple, 9),PyTuple_GET_ITEM(argtuple, 10),PyTuple_GET_ITEM(argtuple, 11) ) != 0) {
    delete struct_ptr;
    return NULL;
  }
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_1671e3fbd8ec9d691ed0580b482ab504_executor), struct_ptr, __struct_compiled_op_1671e3fbd8ec9d691ed0580b482ab504_destructor);
  return thunk; }
...
PyMODINIT_FUNC init1671e3fbd8ec9d691ed0580b482ab504(void){
   import_array();
   (void) Py_InitModule("1671e3fbd8ec9d691ed0580b482ab504", MyMethods);
}
