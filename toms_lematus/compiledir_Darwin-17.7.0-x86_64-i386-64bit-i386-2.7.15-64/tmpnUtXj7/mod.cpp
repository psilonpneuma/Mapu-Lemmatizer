...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_e825522510a267670572230025c273f6 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_e825522510a267670572230025c273f6() {
        ...
        ~__struct_compiled_op_e825522510a267670572230025c273f6(void) {
            cleanup();
        }
...
V17_0_tmp1 = V3_i + V7_i;
npy_bool V17_0_tmp2;
V17_0_tmp2 = (V3_i < V5_i);
V17_tmp1 = V17_0_tmp2 ? V17_0_tmp1 : V3_i;
}

npy_int64 V17_tmp2;
{
npy_bool V17_1_tmp1;
V17_1_tmp1 = (V17_tmp1 < V5_i);
V17_tmp2 = V17_1_tmp1 ? V5_i : V17_tmp1;
}

npy_int64 V17_tmp3;
{
npy_bool V17_2_tmp1;
V17_2_tmp1 = (V17_tmp2 >= V7_i);
V17_tmp3 = V17_2_tmp1 ? V7_i : V17_tmp2;
}

npy_int64 V17_tmp4;
{
npy_bool V17_3_tmp1;
V17_3_tmp1 = (V17_tmp3 < V5_i);
V17_tmp4 = V17_3_tmp1 ? V5_i : V17_tmp3;
}

npy_bool V17_tmp5;
V17_tmp5 = (V17_tmp4 < V9_i);
npy_int64 V17_tmp6;
V17_tmp6 = V17_tmp5 ? V17_tmp4 : V9_i;
npy_int64 V17_tmp7;
V17_tmp7 = V17_tmp6 - V11_i;
npy_int64 V17_tmp8;
V17_tmp8 = V17_tmp7 - V13_i;
V1_i = V17_tmp8 + V15_i;
}
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_e825522510a267670572230025c273f6_executor(__struct_compiled_op_e825522510a267670572230025c273f6* self) {
            return self->run();
        }

        static void __struct_compiled_op_e825522510a267670572230025c273f6_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_e825522510a267670572230025c273f6*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_e825522510a267670572230025c273f6* struct_ptr = new __struct_compiled_op_e825522510a267670572230025c273f6();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_e825522510a267670572230025c273f6_executor), struct_ptr, __struct_compiled_op_e825522510a267670572230025c273f6_destructor);
  return thunk; }
...
PyMODINIT_FUNC inite825522510a267670572230025c273f6(void){
   import_array();
   (void) Py_InitModule("e825522510a267670572230025c273f6", MyMethods);
}
