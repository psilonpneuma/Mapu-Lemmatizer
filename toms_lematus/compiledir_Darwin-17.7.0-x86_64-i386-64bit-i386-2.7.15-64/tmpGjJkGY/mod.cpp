...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_e452eb45875c454458f9ef7ef485b5bb {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_e452eb45875c454458f9ef7ef485b5bb() {
        ...
        ~__struct_compiled_op_e452eb45875c454458f9ef7ef485b5bb(void) {
            cleanup();
        }
...
V11_tmp3 = (V5_i <= V9_i);
npy_int64 V11_tmp4;
V11_tmp4 = V11_tmp3 ? V11_tmp2 : V3_i;
V1_i = V11_tmp1 ? V11_tmp2 : V11_tmp4;
}
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_e452eb45875c454458f9ef7ef485b5bb_executor(__struct_compiled_op_e452eb45875c454458f9ef7ef485b5bb* self) {
            return self->run();
        }

        static void __struct_compiled_op_e452eb45875c454458f9ef7ef485b5bb_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_e452eb45875c454458f9ef7ef485b5bb*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_e452eb45875c454458f9ef7ef485b5bb* struct_ptr = new __struct_compiled_op_e452eb45875c454458f9ef7ef485b5bb();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_e452eb45875c454458f9ef7ef485b5bb_executor), struct_ptr, __struct_compiled_op_e452eb45875c454458f9ef7ef485b5bb_destructor);
  return thunk; }
...
PyMODINIT_FUNC inite452eb45875c454458f9ef7ef485b5bb(void){
   import_array();
   (void) Py_InitModule("e452eb45875c454458f9ef7ef485b5bb", MyMethods);
}
