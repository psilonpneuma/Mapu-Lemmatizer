...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_0abe19206004f55475830d020f9a6684 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_0abe19206004f55475830d020f9a6684() {
        ...
        ~__struct_compiled_op_0abe19206004f55475830d020f9a6684(void) {
            cleanup();
        }
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_0abe19206004f55475830d020f9a6684_executor(__struct_compiled_op_0abe19206004f55475830d020f9a6684* self) {
            return self->run();
        }

        static void __struct_compiled_op_0abe19206004f55475830d020f9a6684_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_0abe19206004f55475830d020f9a6684*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_0abe19206004f55475830d020f9a6684* struct_ptr = new __struct_compiled_op_0abe19206004f55475830d020f9a6684();
  if (struct_ptr->init( PyTuple_GET_ITEM(argtuple, 0),PyTuple_GET_ITEM(argtuple, 1),PyTuple_GET_ITEM(argtuple, 2) ) != 0) {
    delete struct_ptr;
    return NULL;
  }
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_0abe19206004f55475830d020f9a6684_executor), struct_ptr, __struct_compiled_op_0abe19206004f55475830d020f9a6684_destructor);
  return thunk; }
...
PyMODINIT_FUNC init0abe19206004f55475830d020f9a6684(void){
   import_array();
   (void) Py_InitModule("0abe19206004f55475830d020f9a6684", MyMethods);
}
