...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_8a0e3d1c26ef5128046e8379c2bd6031 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_8a0e3d1c26ef5128046e8379c2bd6031() {
        ...
        ~__struct_compiled_op_8a0e3d1c26ef5128046e8379c2bd6031(void) {
            cleanup();
        }
...
V15_1_tmp1 = V5_i + V7_i;
V15_tmp2 = V15_1_tmp1 - V9_i;
}

npy_int64 V15_tmp3;
V15_tmp3 = V15_tmp1 ? V5_i : V13_i;
npy_bool V15_tmp4;
V15_tmp4 = (V15_tmp2 < V11_i);
npy_int64 V15_tmp5;
V15_tmp5 = V15_tmp4 ? V11_i : V15_tmp2;
V1_i = V3_i ? V15_tmp5 : V15_tmp3;
}
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_8a0e3d1c26ef5128046e8379c2bd6031_executor(__struct_compiled_op_8a0e3d1c26ef5128046e8379c2bd6031* self) {
            return self->run();
        }

        static void __struct_compiled_op_8a0e3d1c26ef5128046e8379c2bd6031_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_8a0e3d1c26ef5128046e8379c2bd6031*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_8a0e3d1c26ef5128046e8379c2bd6031* struct_ptr = new __struct_compiled_op_8a0e3d1c26ef5128046e8379c2bd6031();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_8a0e3d1c26ef5128046e8379c2bd6031_executor), struct_ptr, __struct_compiled_op_8a0e3d1c26ef5128046e8379c2bd6031_destructor);
  return thunk; }
...
PyMODINIT_FUNC init8a0e3d1c26ef5128046e8379c2bd6031(void){
   import_array();
   (void) Py_InitModule("8a0e3d1c26ef5128046e8379c2bd6031", MyMethods);
}
