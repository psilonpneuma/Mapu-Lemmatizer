...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_8c603292a18a7bae4b2bd5ab57182ad6 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_8c603292a18a7bae4b2bd5ab57182ad6() {
        ...
        ~__struct_compiled_op_8c603292a18a7bae4b2bd5ab57182ad6(void) {
            cleanup();
        }
...
V17_tmp2 = (V11_i > V5_i);
npy_int64 V17_tmp3;
V17_tmp3 = ((V17_tmp1)>(V15_i)? (V17_tmp1): ((V15_i)>=(V17_tmp1)? (V15_i): nan("")));
npy_bool V17_tmp4;
V17_tmp4 = (V17_tmp1 < V5_i);
npy_bool V17_tmp5;
V17_tmp5 = (V17_tmp4 & V17_tmp2);
npy_int64 V17_tmp6;
V17_tmp6 = V17_tmp5 ? V13_i : V17_tmp3;
V1_i = V3_i ? V5_i : V17_tmp6;
}
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_8c603292a18a7bae4b2bd5ab57182ad6_executor(__struct_compiled_op_8c603292a18a7bae4b2bd5ab57182ad6* self) {
            return self->run();
        }

        static void __struct_compiled_op_8c603292a18a7bae4b2bd5ab57182ad6_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_8c603292a18a7bae4b2bd5ab57182ad6*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_8c603292a18a7bae4b2bd5ab57182ad6* struct_ptr = new __struct_compiled_op_8c603292a18a7bae4b2bd5ab57182ad6();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_8c603292a18a7bae4b2bd5ab57182ad6_executor), struct_ptr, __struct_compiled_op_8c603292a18a7bae4b2bd5ab57182ad6_destructor);
  return thunk; }
...
PyMODINIT_FUNC init8c603292a18a7bae4b2bd5ab57182ad6(void){
   import_array();
   (void) Py_InitModule("8c603292a18a7bae4b2bd5ab57182ad6", MyMethods);
}
