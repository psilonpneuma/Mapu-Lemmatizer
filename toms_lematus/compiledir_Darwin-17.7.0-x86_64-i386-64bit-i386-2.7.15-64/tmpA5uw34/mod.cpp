...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_536d2a147fe78079c2779e1d1e8e4231 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_536d2a147fe78079c2779e1d1e8e4231() {
        ...
        ~__struct_compiled_op_536d2a147fe78079c2779e1d1e8e4231(void) {
            cleanup();
        }
...
V11_tmp2 = V3_i - V5_i;
npy_int64 V11_tmp3;
V11_tmp3 = ((V11_tmp1)>(V11_tmp2)? (V11_tmp1): ((V11_tmp2)>=(V11_tmp1)? (V11_tmp2): nan("")));
V1_i = ((V9_i)<(V11_tmp3)? (V9_i): ((V11_tmp3)<=(V9_i)? (V11_tmp3): nan("")));
}
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_536d2a147fe78079c2779e1d1e8e4231_executor(__struct_compiled_op_536d2a147fe78079c2779e1d1e8e4231* self) {
            return self->run();
        }

        static void __struct_compiled_op_536d2a147fe78079c2779e1d1e8e4231_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_536d2a147fe78079c2779e1d1e8e4231*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_536d2a147fe78079c2779e1d1e8e4231* struct_ptr = new __struct_compiled_op_536d2a147fe78079c2779e1d1e8e4231();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_536d2a147fe78079c2779e1d1e8e4231_executor), struct_ptr, __struct_compiled_op_536d2a147fe78079c2779e1d1e8e4231_destructor);
  return thunk; }
...
PyMODINIT_FUNC init536d2a147fe78079c2779e1d1e8e4231(void){
   import_array();
   (void) Py_InitModule("536d2a147fe78079c2779e1d1e8e4231", MyMethods);
}
