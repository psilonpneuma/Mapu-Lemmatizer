...
#define THEANO_MACRO_MOD(x,y) (x % y)
    ...
    namespace {
    struct __struct_compiled_op_7b7315f27739c3f384536dac72c9ee4b {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_7b7315f27739c3f384536dac72c9ee4b() {
        ...
        ~__struct_compiled_op_7b7315f27739c3f384536dac72c9ee4b(void) {
            cleanup();
        }
...
npy_int64& V21_i = *V21_iter;
                  ...
                  {
npy_int64 V23_tmp1;
V23_tmp1 = V17_i * V19_i * V21_i;
npy_int64 V23_tmp2;
V23_tmp2 = V7_i * V9_i * V11_i;
npy_int64 V23_tmp3;
V23_tmp3 = V13_i * V7_i * V9_i * V11_i;
npy_bool V23_tmp4;
V23_tmp4 = (V3_i == V5_i);
npy_int64 V23_tmp5;
V23_tmp5 = -V23_tmp1;
...
if (V23_tmp2 < 0) {
    if (V23_tmp3 < 0) {
        V23_tmp6 = ((-V23_tmp2) / (-V23_tmp3));
    } else {
        V23_tmp6 = - ((-V23_tmp2) / V23_tmp3) - ((THEANO_MACRO_MOD((-V23_tmp2), V23_tmp3) == 0) ? 0 : 1);
    }
} else {
    if (V23_tmp3 < 0) {
        V23_tmp6 = - (V23_tmp2 / (-V23_tmp3)) - ((THEANO_MACRO_MOD(V23_tmp2, (-V23_tmp3)) == 0) ? 0 : 1);
...
npy_int64 V23_tmp7;
V23_tmp7 = V23_tmp4 ? V23_tmp6 : V3_i;
npy_int64 V23_tmp8;
V23_tmp8 = V23_tmp7 * V15_i;

if (V23_tmp8 < 0) {
    if (V23_tmp5 < 0) {
        V1_i = ((-V23_tmp8) / (-V23_tmp5));
    } else {
        V1_i = - ((-V23_tmp8) / V23_tmp5) - ((THEANO_MACRO_MOD((-V23_tmp8), V23_tmp5) == 0) ? 0 : 1);
    }
} else {
    if (V23_tmp5 < 0) {
        V1_i = - (V23_tmp8 / (-V23_tmp5)) - ((THEANO_MACRO_MOD(V23_tmp8, (-V23_tmp5)) == 0) ? 0 : 1);
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_7b7315f27739c3f384536dac72c9ee4b_executor(__struct_compiled_op_7b7315f27739c3f384536dac72c9ee4b* self) {
            return self->run();
        }

        static void __struct_compiled_op_7b7315f27739c3f384536dac72c9ee4b_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_7b7315f27739c3f384536dac72c9ee4b*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_7b7315f27739c3f384536dac72c9ee4b* struct_ptr = new __struct_compiled_op_7b7315f27739c3f384536dac72c9ee4b();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_7b7315f27739c3f384536dac72c9ee4b_executor), struct_ptr, __struct_compiled_op_7b7315f27739c3f384536dac72c9ee4b_destructor);
  return thunk; }
...
PyMODINIT_FUNC init7b7315f27739c3f384536dac72c9ee4b(void){
   import_array();
   (void) Py_InitModule("7b7315f27739c3f384536dac72c9ee4b", MyMethods);
}
