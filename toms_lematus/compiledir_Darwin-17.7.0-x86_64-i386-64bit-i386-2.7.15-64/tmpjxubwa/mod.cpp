...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_0fe5610db33c05e7643fc028889d91b3 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_0fe5610db33c05e7643fc028889d91b3() {
        ...
        ~__struct_compiled_op_0fe5610db33c05e7643fc028889d91b3(void) {
            cleanup();
        }
...
dims[1] = V5_n1;
        ...
        if (!V1) {
            V1 = (PyArrayObject*)PyArray_EMPTY(2, dims,
                                                    NPY_FLOAT32,
                                                    PyArray_ISFORTRAN(V5) && PyArray_ISFORTRAN(V7) && PyArray_ISFORTRAN(V11) && PyArray_ISFORTRAN(V13) && PyArray_ISFORTRAN(V15));
        }
        else {
        ...
        goto __label_19;}
            ...
            if((PyArray_ISCONTIGUOUS(V5) && PyArray_ISCONTIGUOUS(V7) && PyArray_ISCONTIGUOUS(V11) && PyArray_ISCONTIGUOUS(V13) && PyArray_ISCONTIGUOUS(V15) && PyArray_ISCONTIGUOUS(V1)) || (PyArray_ISFORTRAN(V5) && PyArray_ISFORTRAN(V7) && PyArray_ISFORTRAN(V11) && PyArray_ISFORTRAN(V13) && PyArray_ISFORTRAN(V15) && PyArray_ISFORTRAN(V1))){
            ...
            dtype_V13 * V13_ptr = (dtype_V13*) PyArray_DATA(V13);
                            
            dtype_V15 * V15_ptr = (dtype_V15*) PyArray_DATA(V15);
                            
            dtype_V17& V17_i = ((dtype_V17*) PyArray_DATA(V17))[0];
            ...
            dtype_V13& V13_i = V13_ptr[i];
                            
            dtype_V15& V15_i = V15_ptr[i];
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_0fe5610db33c05e7643fc028889d91b3_executor(__struct_compiled_op_0fe5610db33c05e7643fc028889d91b3* self) {
            return self->run();
        }

        static void __struct_compiled_op_0fe5610db33c05e7643fc028889d91b3_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_0fe5610db33c05e7643fc028889d91b3*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_0fe5610db33c05e7643fc028889d91b3* struct_ptr = new __struct_compiled_op_0fe5610db33c05e7643fc028889d91b3();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_0fe5610db33c05e7643fc028889d91b3_executor), struct_ptr, __struct_compiled_op_0fe5610db33c05e7643fc028889d91b3_destructor);
  return thunk; }
...
PyMODINIT_FUNC init0fe5610db33c05e7643fc028889d91b3(void){
   import_array();
   (void) Py_InitModule("0fe5610db33c05e7643fc028889d91b3", MyMethods);
}
