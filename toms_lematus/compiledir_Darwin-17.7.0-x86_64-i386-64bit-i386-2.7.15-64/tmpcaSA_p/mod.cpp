...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_d521072a1029cc78a3d15548de24847e {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_d521072a1029cc78a3d15548de24847e() {
        ...
        ~__struct_compiled_op_d521072a1029cc78a3d15548de24847e(void) {
            cleanup();
        }
...
V23_tmp3 = V23_2_tmp1 ? V5_i : V23_tmp2;
}

npy_int64 V23_tmp4;
{
npy_bool V23_3_tmp1;
V23_3_tmp1 = (V23_tmp3 >= V19_i);
V23_tmp4 = V23_3_tmp1 ? V19_i : V23_tmp3;
}

npy_int64 V23_tmp5;
{
npy_bool V23_4_tmp1;
V23_4_tmp1 = (V23_tmp4 < V5_i);
V23_tmp5 = V23_4_tmp1 ? V5_i : V23_tmp4;
}

npy_bool V23_tmp6;
V23_tmp6 = (V23_tmp5 < V21_i);
V1_i = V23_tmp6 ? V23_tmp5 : V21_i;
}
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_d521072a1029cc78a3d15548de24847e_executor(__struct_compiled_op_d521072a1029cc78a3d15548de24847e* self) {
            return self->run();
        }

        static void __struct_compiled_op_d521072a1029cc78a3d15548de24847e_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_d521072a1029cc78a3d15548de24847e*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_d521072a1029cc78a3d15548de24847e* struct_ptr = new __struct_compiled_op_d521072a1029cc78a3d15548de24847e();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_d521072a1029cc78a3d15548de24847e_executor), struct_ptr, __struct_compiled_op_d521072a1029cc78a3d15548de24847e_destructor);
  return thunk; }
...
PyMODINIT_FUNC initd521072a1029cc78a3d15548de24847e(void){
   import_array();
   (void) Py_InitModule("d521072a1029cc78a3d15548de24847e", MyMethods);
}
