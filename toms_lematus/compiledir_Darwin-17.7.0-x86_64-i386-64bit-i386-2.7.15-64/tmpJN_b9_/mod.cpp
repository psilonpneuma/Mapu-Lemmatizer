...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_0733a0e9a1cd32629094703b233969ca {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_0733a0e9a1cd32629094703b233969ca() {
        ...
        ~__struct_compiled_op_0733a0e9a1cd32629094703b233969ca(void) {
            cleanup();
        }
...
V11_tmp2 = V5_i + V7_i;
npy_int64 V11_tmp3;
V11_tmp3 = V11_tmp1 ? V5_i : V7_i;
npy_bool V11_tmp4;
V11_tmp4 = (V11_tmp2 < V9_i);
npy_int64 V11_tmp5;
V11_tmp5 = V11_tmp4 ? V9_i : V11_tmp2;
V1_i = V3_i ? V11_tmp5 : V11_tmp3;
}
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_0733a0e9a1cd32629094703b233969ca_executor(__struct_compiled_op_0733a0e9a1cd32629094703b233969ca* self) {
            return self->run();
        }

        static void __struct_compiled_op_0733a0e9a1cd32629094703b233969ca_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_0733a0e9a1cd32629094703b233969ca*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_0733a0e9a1cd32629094703b233969ca* struct_ptr = new __struct_compiled_op_0733a0e9a1cd32629094703b233969ca();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_0733a0e9a1cd32629094703b233969ca_executor), struct_ptr, __struct_compiled_op_0733a0e9a1cd32629094703b233969ca_destructor);
  return thunk; }
...
PyMODINIT_FUNC init0733a0e9a1cd32629094703b233969ca(void){
   import_array();
   (void) Py_InitModule("0733a0e9a1cd32629094703b233969ca", MyMethods);
}
