...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_f69b0162e5dc552962e649ec932e1b1e {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_f69b0162e5dc552962e649ec932e1b1e() {
        ...
        ~__struct_compiled_op_f69b0162e5dc552962e649ec932e1b1e(void) {
            cleanup();
        }
...
dims[1] =((npy_intp)((dtype_V5*) PyArray_DATA(V5))[0]);
dims[2] =((npy_intp)((dtype_V7*) PyArray_DATA(V7))[0]);
if(V1==NULL
||PyArray_DIMS(V1)[0]!=dims[0]||PyArray_DIMS(V1)[1]!=dims[1]||PyArray_DIMS(V1)[2]!=dims[2]){
            /* Reference received to invalid output variable.
            Decrease received reference's ref count and allocate new
            output variable */
            Py_XDECREF(V1);
            V1 = (PyArrayObject*)PyArray_EMPTY(3,
                                                    dims,
                                                    NPY_FLOAT32,
                                                    0);
            if (!V1)
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_f69b0162e5dc552962e649ec932e1b1e_executor(__struct_compiled_op_f69b0162e5dc552962e649ec932e1b1e* self) {
            return self->run();
        }

        static void __struct_compiled_op_f69b0162e5dc552962e649ec932e1b1e_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_f69b0162e5dc552962e649ec932e1b1e*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_f69b0162e5dc552962e649ec932e1b1e* struct_ptr = new __struct_compiled_op_f69b0162e5dc552962e649ec932e1b1e();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_f69b0162e5dc552962e649ec932e1b1e_executor), struct_ptr, __struct_compiled_op_f69b0162e5dc552962e649ec932e1b1e_destructor);
  return thunk; }
...
PyMODINIT_FUNC initf69b0162e5dc552962e649ec932e1b1e(void){
   import_array();
   (void) Py_InitModule("f69b0162e5dc552962e649ec932e1b1e", MyMethods);
}
