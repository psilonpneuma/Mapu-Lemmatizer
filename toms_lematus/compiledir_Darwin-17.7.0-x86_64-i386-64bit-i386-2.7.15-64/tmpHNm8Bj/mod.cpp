...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_1f88f775ffa65a05866ce13d1939617c {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_1f88f775ffa65a05866ce13d1939617c() {
        ...
        ~__struct_compiled_op_1f88f775ffa65a05866ce13d1939617c(void) {
            cleanup();
        }
...
// Op class mrg_uniform
        ...
        {
            Py_XDECREF(V1);
            V1 = (PyArrayObject*)PyArray_SimpleNew(3, odims, 11);
            if(!V1) {
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_1f88f775ffa65a05866ce13d1939617c_executor(__struct_compiled_op_1f88f775ffa65a05866ce13d1939617c* self) {
            return self->run();
        }

        static void __struct_compiled_op_1f88f775ffa65a05866ce13d1939617c_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_1f88f775ffa65a05866ce13d1939617c*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_1f88f775ffa65a05866ce13d1939617c* struct_ptr = new __struct_compiled_op_1f88f775ffa65a05866ce13d1939617c();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_1f88f775ffa65a05866ce13d1939617c_executor), struct_ptr, __struct_compiled_op_1f88f775ffa65a05866ce13d1939617c_destructor);
  return thunk; }
...
PyMODINIT_FUNC init1f88f775ffa65a05866ce13d1939617c(void){
   import_array();
   (void) Py_InitModule("1f88f775ffa65a05866ce13d1939617c", MyMethods);
}
