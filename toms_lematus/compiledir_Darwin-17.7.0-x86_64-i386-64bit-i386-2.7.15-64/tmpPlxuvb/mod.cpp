...
#define THEANO_MACRO_MOD(x,y) (x % y)
    ...
    namespace {
    struct __struct_compiled_op_ef1f4fd4f5621d278b33440fdf398678 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_ef1f4fd4f5621d278b33440fdf398678() {
        ...
        ~__struct_compiled_op_ef1f4fd4f5621d278b33440fdf398678(void) {
            cleanup();
        }
...
npy_int64 V17_tmp1;
{
npy_int64 V17_0_tmp1;
V17_0_tmp1 = V5_i - V7_i;
npy_int64 V17_0_tmp2;
V17_0_tmp2 = V17_0_tmp1 - V9_i;
npy_int64 V17_0_tmp3;

if (V17_0_tmp2 < 0) {
    if (V11_i < 0) {
        V17_0_tmp3 = ((-V17_0_tmp2) / (-V11_i));
    } else {
        V17_0_tmp3 = - ((-V17_0_tmp2) / V11_i) - ((THEANO_MACRO_MOD((-V17_0_tmp2), V11_i) == 0) ? 0 : 1);
    }
} else {
    if (V11_i < 0) {
        V17_0_tmp3 = - (V17_0_tmp2 / (-V11_i)) - ((THEANO_MACRO_MOD(V17_0_tmp2, (-V11_i)) == 0) ? 0 : 1);
...
V17_tmp1 = V17_0_tmp3 + V11_i;
}

npy_int64 V17_tmp2;
{
npy_bool V17_1_tmp1;
V17_1_tmp1 = (V17_tmp1 < V13_i);
npy_int64 V17_1_tmp2;
V17_1_tmp2 = V17_1_tmp1 ? V13_i : V17_tmp1;
npy_int64 V17_1_tmp3;
V17_1_tmp3 = V17_1_tmp2 - V9_i;
npy_int64 V17_1_tmp4;
V17_1_tmp4 = V3_i - V17_1_tmp3;
V17_tmp2 = V17_1_tmp4 - V9_i;
}

npy_int64 V17_tmp3;
{
npy_int64 V17_2_tmp1;
V17_2_tmp1 = V3_i - V9_i;
npy_bool V17_2_tmp2;
V17_2_tmp2 = (V17_tmp2 < V13_i);
V17_tmp3 = V17_2_tmp2 ? V17_2_tmp1 : V17_tmp2;
}

npy_int64 V17_tmp4;
{
npy_bool V17_3_tmp1;
V17_3_tmp1 = (V17_tmp3 < V13_i);
V17_tmp4 = V17_3_tmp1 ? V13_i : V17_tmp3;
}

npy_bool V17_tmp5;
V17_tmp5 = (V17_tmp4 < V15_i);
V1_i = V17_tmp5 ? V17_tmp4 : V15_i;
}
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_ef1f4fd4f5621d278b33440fdf398678_executor(__struct_compiled_op_ef1f4fd4f5621d278b33440fdf398678* self) {
            return self->run();
        }

        static void __struct_compiled_op_ef1f4fd4f5621d278b33440fdf398678_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_ef1f4fd4f5621d278b33440fdf398678*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_ef1f4fd4f5621d278b33440fdf398678* struct_ptr = new __struct_compiled_op_ef1f4fd4f5621d278b33440fdf398678();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_ef1f4fd4f5621d278b33440fdf398678_executor), struct_ptr, __struct_compiled_op_ef1f4fd4f5621d278b33440fdf398678_destructor);
  return thunk; }
...
PyMODINIT_FUNC initef1f4fd4f5621d278b33440fdf398678(void){
   import_array();
   (void) Py_InitModule("ef1f4fd4f5621d278b33440fdf398678", MyMethods);
}
