...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_393e191fc59a47894861ec102eff880c {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_393e191fc59a47894861ec102eff880c() {
        ...
        ~__struct_compiled_op_393e191fc59a47894861ec102eff880c(void) {
            cleanup();
        }
            ...
            
{
    ...
    std::vector< std::pair<int, int> > V11_loops(2);
    std::vector< std::pair<int, int> >::iterator V11_loops_it = V11_loops.begin();
    
            V11_loops_it->first = abs(PyArray_STRIDES(V11)[0]);
...
V17_stride0, 0
    ...
    std::vector< std::pair<int, int> >::reverse_iterator V11_loops_rit;
        ...
        V11_loops_rit = V11_loops.rbegin();
            int V3_stride_l1 = init_strides[0][V11_loops_rit->second];
            ++V11_loops_rit;
            
            int V3_stride_l0 = init_strides[0][V11_loops_rit->second];
            ++V11_loops_rit;
            
        V11_loops_rit = V11_loops.rbegin();
            int V5_stride_l1 = init_strides[1][V11_loops_rit->second];
            ++V11_loops_rit;
            
            int V5_stride_l0 = init_strides[1][V11_loops_rit->second];
            ++V11_loops_rit;
        ...
        V11_loops_rit = V11_loops.rbegin();
            int V9_stride_l1 = init_strides[3][V11_loops_rit->second];
            ++V11_loops_rit;
            
            int V9_stride_l0 = init_strides[3][V11_loops_rit->second];
            ++V11_loops_rit;
            
        V11_loops_rit = V11_loops.rbegin();
            int V11_stride_l1 = init_strides[4][V11_loops_rit->second];
            ++V11_loops_rit;
            
            int V11_stride_l0 = init_strides[4][V11_loops_rit->second];
            ++V11_loops_rit;
            
        V11_loops_rit = V11_loops.rbegin();
            int V13_stride_l1 = init_strides[5][V11_loops_rit->second];
            ++V11_loops_rit;
            
            int V13_stride_l0 = init_strides[5][V11_loops_rit->second];
            ++V11_loops_rit;
            
        V11_loops_rit = V11_loops.rbegin();
            int V15_stride_l1 = init_strides[6][V11_loops_rit->second];
            ++V11_loops_rit;
            
            int V15_stride_l0 = init_strides[6][V11_loops_rit->second];
            ++V11_loops_rit;
            
        V11_loops_rit = V11_loops.rbegin();
            int V17_stride_l1 = init_strides[7][V11_loops_rit->second];
            ++V11_loops_rit;
            
            int V17_stride_l0 = init_strides[7][V11_loops_rit->second];
            ++V11_loops_rit;
...
V19_tmp2 = V11_i * V13_i;
npy_float32 V19_tmp3;
V19_tmp3 = V5_i * V7_i;
npy_float32 V19_tmp4;
V19_tmp4 = V9_i - V5_i;
npy_float32 V19_tmp5;
V19_tmp5 = V19_tmp2 + V15_i;
npy_float32 V19_tmp6;
V19_tmp6 = tanh(V19_tmp5);
npy_float32 V19_tmp7;
V19_tmp7 = V19_tmp4 * V19_tmp6;
npy_float32 V19_tmp8;
V19_tmp8 = V19_tmp3 + V19_tmp7;
npy_float32 V19_tmp9;
V19_tmp9 = V3_i * V19_tmp8;
V1_i = V19_tmp9 + V19_tmp1;
}
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_393e191fc59a47894861ec102eff880c_executor(__struct_compiled_op_393e191fc59a47894861ec102eff880c* self) {
            return self->run();
        }

        static void __struct_compiled_op_393e191fc59a47894861ec102eff880c_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_393e191fc59a47894861ec102eff880c*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_393e191fc59a47894861ec102eff880c* struct_ptr = new __struct_compiled_op_393e191fc59a47894861ec102eff880c();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_393e191fc59a47894861ec102eff880c_executor), struct_ptr, __struct_compiled_op_393e191fc59a47894861ec102eff880c_destructor);
  return thunk; }
...
PyMODINIT_FUNC init393e191fc59a47894861ec102eff880c(void){
   import_array();
   (void) Py_InitModule("393e191fc59a47894861ec102eff880c", MyMethods);
}
