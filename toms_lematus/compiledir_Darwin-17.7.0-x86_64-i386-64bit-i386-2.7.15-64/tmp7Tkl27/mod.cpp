...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_2a42d381a61cc6db30ae0334cc1e3126 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_2a42d381a61cc6db30ae0334cc1e3126() {
        ...
        ~__struct_compiled_op_2a42d381a61cc6db30ae0334cc1e3126(void) {
            cleanup();
        }
...
V7_tmp1 = V3_i + V5_i;
npy_bool V7_tmp2;
V7_tmp2 = (V5_i < V7_tmp1);
npy_int64 V7_tmp3;
V7_tmp3 = V7_tmp2 ? V5_i : V7_tmp1;
npy_int64 V7_tmp4;
V7_tmp4 = V3_i - V7_tmp3;
V1_i = V7_tmp4 + V5_i;
}
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_2a42d381a61cc6db30ae0334cc1e3126_executor(__struct_compiled_op_2a42d381a61cc6db30ae0334cc1e3126* self) {
            return self->run();
        }

        static void __struct_compiled_op_2a42d381a61cc6db30ae0334cc1e3126_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_2a42d381a61cc6db30ae0334cc1e3126*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_2a42d381a61cc6db30ae0334cc1e3126* struct_ptr = new __struct_compiled_op_2a42d381a61cc6db30ae0334cc1e3126();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_2a42d381a61cc6db30ae0334cc1e3126_executor), struct_ptr, __struct_compiled_op_2a42d381a61cc6db30ae0334cc1e3126_destructor);
  return thunk; }
...
PyMODINIT_FUNC init2a42d381a61cc6db30ae0334cc1e3126(void){
   import_array();
   (void) Py_InitModule("2a42d381a61cc6db30ae0334cc1e3126", MyMethods);
}
