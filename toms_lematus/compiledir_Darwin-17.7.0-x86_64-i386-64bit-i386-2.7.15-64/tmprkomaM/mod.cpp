...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_b790c1678e4c13551cebd6a5c9dfb01b {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_b790c1678e4c13551cebd6a5c9dfb01b() {
        ...
        ~__struct_compiled_op_b790c1678e4c13551cebd6a5c9dfb01b(void) {
            cleanup();
        }
...
// Op class Argmax
        ...
        Py_CLEAR(V1);//todo pass them as out parameter.
        
            axis = ((dtype_V5*)PyArray_DATA(V5))[0];
            if(axis > PyArray_NDIM(V3)-1 || axis < -PyArray_NDIM(V3)){
        ...
        V1 = (PyArrayObject*)PyArray_ArgMax(V3, axis, NULL);
        if(V1 == NULL){
            {
        __failure = 7;
        if (!PyErr_Occurred()) {
        ...
        if(!PyArray_CheckExact(V1)){
            V1 = (PyArrayObject*)PyArray_FromAny((PyObject*)V1, NULL, 0, 0, NPY_ARRAY_ENSUREARRAY, NULL);
            if(V1 == NULL){
                {
        __failure = 7;
        if (!PyErr_Occurred()) {
        ...
        if(PyArray_TYPE(V1) != NPY_INT64){
            PyObject * tmp = PyArray_Cast(V1, NPY_INT64);
            if (NULL == tmp){
                {
        __failure = 7;
        if (!PyErr_Occurred()) {
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_b790c1678e4c13551cebd6a5c9dfb01b_executor(__struct_compiled_op_b790c1678e4c13551cebd6a5c9dfb01b* self) {
            return self->run();
        }

        static void __struct_compiled_op_b790c1678e4c13551cebd6a5c9dfb01b_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_b790c1678e4c13551cebd6a5c9dfb01b*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_b790c1678e4c13551cebd6a5c9dfb01b* struct_ptr = new __struct_compiled_op_b790c1678e4c13551cebd6a5c9dfb01b();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_b790c1678e4c13551cebd6a5c9dfb01b_executor), struct_ptr, __struct_compiled_op_b790c1678e4c13551cebd6a5c9dfb01b_destructor);
  return thunk; }
...
PyMODINIT_FUNC initb790c1678e4c13551cebd6a5c9dfb01b(void){
   import_array();
   (void) Py_InitModule("b790c1678e4c13551cebd6a5c9dfb01b", MyMethods);
}
