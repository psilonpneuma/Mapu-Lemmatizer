...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_e287ed6f2979c014a1dbb9fbe37ecae9 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_e287ed6f2979c014a1dbb9fbe37ecae9() {
        ...
        ~__struct_compiled_op_e287ed6f2979c014a1dbb9fbe37ecae9(void) {
            cleanup();
        }
        ...
        
{
    ...
    {Py_XINCREF(py_V7);}
            ...
            if (!PyObject_TypeCheck(py_V7, &PyInt8ArrType_Type))
            {
...
{
// Op class MultinomialFromUniform
        ...
        if (PyArray_DIMS(V5)[0] != (PyArray_DIMS(V3)[0] * V7))
        {
        ...
        {
            Py_XDECREF(V1);
            V1 = (PyArrayObject*) PyArray_EMPTY(2,
                PyArray_DIMS(V3),
                NPY_INT64,
                0);
            if (!V1)
        ...
        const int nb_multi = PyArray_DIMS(V3)[0];
        const int nb_outcomes = PyArray_DIMS(V3)[1];
        const int n_samples = V7;
        ...
        for (int c = 0; c < n_samples; ++c){
            for (int n = 0; n < nb_multi; ++n)
            {
                int waiting = 1;
                double cummul = 0.;
                const dtype_V5* unis_n = (dtype_V5*)PyArray_GETPTR1(V5, c*nb_multi + n);
                for (int m = 0; m < nb_outcomes; ++m)
                {
                    dtype_V1* z_nm = (dtype_V1*)PyArray_GETPTR2(V1, n,m);
                    const dtype_V3* pvals_nm = (dtype_V3*)PyArray_GETPTR2(V3, n,m);
                    cummul += *pvals_nm;
                    if (c == 0)
                    {
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_e287ed6f2979c014a1dbb9fbe37ecae9_executor(__struct_compiled_op_e287ed6f2979c014a1dbb9fbe37ecae9* self) {
            return self->run();
        }

        static void __struct_compiled_op_e287ed6f2979c014a1dbb9fbe37ecae9_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_e287ed6f2979c014a1dbb9fbe37ecae9*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_e287ed6f2979c014a1dbb9fbe37ecae9* struct_ptr = new __struct_compiled_op_e287ed6f2979c014a1dbb9fbe37ecae9();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_e287ed6f2979c014a1dbb9fbe37ecae9_executor), struct_ptr, __struct_compiled_op_e287ed6f2979c014a1dbb9fbe37ecae9_destructor);
  return thunk; }
...
PyMODINIT_FUNC inite287ed6f2979c014a1dbb9fbe37ecae9(void){
   import_array();
   (void) Py_InitModule("e287ed6f2979c014a1dbb9fbe37ecae9", MyMethods);
}
