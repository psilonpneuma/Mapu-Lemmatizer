...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_b330b1d46ecde1ffe50b643c9b8d1a8b {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_b330b1d46ecde1ffe50b643c9b8d1a8b() {
        ...
        ~__struct_compiled_op_b330b1d46ecde1ffe50b643c9b8d1a8b(void) {
            cleanup();
        }
...
// Op class SoftmaxWithBias
            ...
            || (PyArray_DIMS(V1)[1] != PyArray_DIMS(V3)[1]))
        {
            ...
            V1 = (PyArrayObject*)PyArray_SimpleNew(2, PyArray_DIMS(V3),
                                                       PyArray_TYPE(V3));
            if(!V1) {
        ...
        Ssm = PyArray_STRIDES(V1)[1]/sizeof(dtype_V1);
        ...
        for (size_t i = 0; i < Nx[0]; ++i)
        {
            ...
            dtype_V1* __restrict__ sm_i = (dtype_V1*)(PyArray_BYTES(V1) + PyArray_STRIDES(V1)[0] * i);

            npy_intp Sx = PyArray_STRIDES(V3)[1]/sizeof(dtype_V3);
            npy_intp Sb = PyArray_STRIDES(V5)[0]/sizeof(dtype_V5);
            npy_intp Ssm = PyArray_STRIDES(V1)[1]/sizeof(dtype_V1);

            size_t row_max_j=0;
            dtype_V1 row_max = x_i[0] + b_i[0];
            //std::cout << "0 " << row_max << "\n";
            // Get the maximum value of the row
            for (j = 1; j < Nx[1]; ++j)
            {
                dtype_V1 row_ij = x_i[j * Sx] +  b_i[j * Sb];
                //std::cout << "1 " << row_ij << "\n";
            ...
            for (j = 0; j < Nx[1]; ++j)
            {
                ...
                dtype_V1 sm_ij = exp(row_ij - row_max);
                //std::cout << "3 " << j << " " << sm_ij << "\n";
                sum += sm_ij;
                sm_i[j * Ssm] = sm_ij;
            }
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_b330b1d46ecde1ffe50b643c9b8d1a8b_executor(__struct_compiled_op_b330b1d46ecde1ffe50b643c9b8d1a8b* self) {
            return self->run();
        }

        static void __struct_compiled_op_b330b1d46ecde1ffe50b643c9b8d1a8b_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_b330b1d46ecde1ffe50b643c9b8d1a8b*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_b330b1d46ecde1ffe50b643c9b8d1a8b* struct_ptr = new __struct_compiled_op_b330b1d46ecde1ffe50b643c9b8d1a8b();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_b330b1d46ecde1ffe50b643c9b8d1a8b_executor), struct_ptr, __struct_compiled_op_b330b1d46ecde1ffe50b643c9b8d1a8b_destructor);
  return thunk; }
...
PyMODINIT_FUNC initb330b1d46ecde1ffe50b643c9b8d1a8b(void){
   import_array();
   (void) Py_InitModule("b330b1d46ecde1ffe50b643c9b8d1a8b", MyMethods);
}
