...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_e5d493821f0a623eff2ce9965367e626 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_e5d493821f0a623eff2ce9965367e626() {
        ...
        ~__struct_compiled_op_e5d493821f0a623eff2ce9965367e626(void) {
            cleanup();
        }
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_e5d493821f0a623eff2ce9965367e626_executor(__struct_compiled_op_e5d493821f0a623eff2ce9965367e626* self) {
            return self->run();
        }

        static void __struct_compiled_op_e5d493821f0a623eff2ce9965367e626_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_e5d493821f0a623eff2ce9965367e626*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_e5d493821f0a623eff2ce9965367e626* struct_ptr = new __struct_compiled_op_e5d493821f0a623eff2ce9965367e626();
  if (struct_ptr->init( PyTuple_GET_ITEM(argtuple, 0),PyTuple_GET_ITEM(argtuple, 1),PyTuple_GET_ITEM(argtuple, 2) ) != 0) {
    delete struct_ptr;
    return NULL;
  }
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_e5d493821f0a623eff2ce9965367e626_executor), struct_ptr, __struct_compiled_op_e5d493821f0a623eff2ce9965367e626_destructor);
  return thunk; }
...
PyMODINIT_FUNC inite5d493821f0a623eff2ce9965367e626(void){
   import_array();
   (void) Py_InitModule("e5d493821f0a623eff2ce9965367e626", MyMethods);
}
